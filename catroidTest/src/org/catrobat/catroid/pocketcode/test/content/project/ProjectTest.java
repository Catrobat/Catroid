 ...
 */
package org.catrobat.catroid.pocketcode.test.content.project;
...
public class ProjectTest extends AndroidTestCase {
	...
	public void testVersionName() throws NameNotFoundException {
		...
		PackageInfo packageInfo = getContext().getPackageManager().getPackageInfo("org.catrobat.catroid.pocketcode", 0);
