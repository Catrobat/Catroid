...
public class SetXActionTest extends AndroidTestCase {
	...
	public void testNormalBehavior() {
		...
		Action action = factory.createSetXAction(sprite, xPosition);
		action.act(1.0f);
	...
	public void testBoundaryPositions() {
		...
		ActionFactory factory = sprite.getActionFactory();
		Action action = factory.createSetXAction(sprite, new Formula(Integer.MAX_VALUE));
		action.act(1.0f);
		...
		action = factory.createSetXAction(sprite, new Formula(Integer.MIN_VALUE));
		action.act(1.0f);
