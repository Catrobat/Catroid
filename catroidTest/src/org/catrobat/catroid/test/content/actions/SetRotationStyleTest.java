...
public class SetRotationStyleTest extends AndroidTestCase {
	...
	public void testNormalMode() {
		ExtendedActions.setRotationStyle(sprite, new Formula(1));
	...
	public void testLRMode() {
		ExtendedActions.setRotationStyle(sprite, new Formula(0));
	...
	public void testNoMode() {
		ExtendedActions.setRotationStyle(sprite, new Formula(2));
