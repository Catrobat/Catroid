...
public class ChangeColorByNActionTest extends AndroidTestCase {
	...
	public void testNullFormula() {
		...
		assertEquals("Incorrect sprite color value after ChangeColorByNBrick executed", 25,
				sprite.look.getColorInUserInterfaceDimensionUnit());
	}
	...
	public void testWrapAround() {
		ExtendedActions.setColorTo(sprite, new Formula(199)).act(1.0f);
		assertEquals("Unexpected initial sprite color value", 199, sprite.look.getColorInUserInterfaceDimensionUnit());

		ExtendedActions.changeColorByN(sprite, new Formula(DELTA)).act(1.0f);
		assertEquals("Incorrect sprite color value after ChangeColorByNAction executed", 0,
				sprite.look.getColorInUserInterfaceDimensionUnit());

		ExtendedActions.changeColorByN(sprite, new Formula(-DELTA)).act(1.0f);
		assertEquals("Incorrect sprite color value after ChangeColorByNAction executed", 199,
				sprite.look.getColorInUserInterfaceDimensionUnit());
	}
}
