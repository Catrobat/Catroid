...
public class SensorTest extends InstrumentationTestCase {
	...
	public void testSensors() throws SecurityException, IllegalArgumentException, NoSuchFieldException,
		...
		double expectedOrientationZ = Double.valueOf(orientations[0]) * SensorHandler.radianToDegreeConst * -1f;
		double expectedOrientationX = Double.valueOf(orientations[2]) * SensorHandler.radianToDegreeConst;
		double expectedOrientationY = Double.valueOf(orientations[1]) * SensorHandler.radianToDegreeConst * -1f;
