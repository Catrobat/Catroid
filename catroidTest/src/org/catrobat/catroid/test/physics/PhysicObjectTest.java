...
public class PhysicObjectTest extends AndroidTestCase {
	...
	public void testDefaultProperties() {
		PhysicsObject physicsObject = PhysicsTestUtils.createPhysicObject(physicsWorld);
	...
	public void testSetShape() {
		...
		checkIfShapesAreTheSameAsInPhysicObject(rectangle, PhysicsTestUtils.getBody(physicsObject));
	}
	...
	public void testSetNullShapeRemovesAllFixtures() {
		...
		assertNull("Physic shape isn't null", PhysicsTestUtils.getShapes(physicsObject));
	...
	public void testSetCollisionBits() {
		PhysicsObject physicsObject = PhysicsTestUtils.createPhysicObject(physicsWorld, PhysicsObject.Type.NONE, 10.0f,
				5.0f);
	...
	public void testSetTypeToDynamicUpdatesMass() {
		PhysicsObject physicsObject = PhysicsTestUtils.createPhysicObject(physicsWorld, PhysicsObject.Type.NONE);
		Body body = PhysicsTestUtils.getBody(physicsObject);
	...
	public void testSetDensityUpdatesMassData() {
		PhysicsObject physicsObject = PhysicsTestUtils.createPhysicObject(physicsWorld, PhysicsObject.Type.DYNAMIC,
				5.0f, 5.0f);
		Body body = PhysicsTestUtils.getBody(physicsObject);
	...
	public void testMass() {
		for (PhysicsObject.Type type : PhysicsObject.Type.values()) {
			PhysicsObject physicsObject = PhysicsTestUtils.createPhysicObject(physicsWorld, type, 5.0f, 5.0f);
			Body body = PhysicsTestUtils.getBody(physicsObject);
	...
	public void testMassWithNoShapeArea() {
		PhysicsObject[] physicsObjects = {
				PhysicsTestUtils.createPhysicObject(physicsWorld, PhysicsObject.Type.DYNAMIC),
				PhysicsTestUtils.createPhysicObject(physicsWorld, PhysicsObject.Type.DYNAMIC, 0.0f, 0.0f) };
