...
public class SetRotationStyleTest extends BaseActivityInstrumentationTestCase<ScriptActivity> {
	...
	public void testSetRotationStyleBrick() {
		...
		assertNotNull("TextView does not exist.", solo.getText(solo.getString(R.string.brick_set_rotation_style_set_to)));
		assertNotNull("Spinner does not exist.", solo.getView(R.id.brick_set_rotation_style_spinner));
		assertNotNull("Text View does not exist.", solo.getText(solo.getString(R.string.brick_set_rotation_style_rotation_style)));
	}
