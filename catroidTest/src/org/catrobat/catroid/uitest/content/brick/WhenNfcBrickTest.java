...
public class WhenNfcBrickTest extends BaseActivityInstrumentationTestCase<MainMenuActivity> {
	...
	public void testNfcSensorVariable() {
		...
		int tagID1 = NfcHandler.byteArrayToInt(nfcIdString1.getBytes()); //825373492
		int tagID2 = NfcHandler.byteArrayToInt(nfcIdString2.getBytes()); //909456435
		int waitingTime = 500;
		String newText = solo.getString(R.string.new_nfc_tag);
	...
	private void createProject() {
		...
		tagData.setNfcTagUid(String.valueOf(NfcHandler.byteArrayToInt(FIRST_TEST_TAG_ID.getBytes())));
		tagDataList.add(tagData);

		NfcTagData tagData2 = new NfcTagData();
		tagData2.setNfcTagName(SECOND_TEST_TAG_NAME);
		tagData2.setNfcTagUid(String.valueOf(NfcHandler.byteArrayToInt(SECOND_TEST_TAG_ID.getBytes())));
