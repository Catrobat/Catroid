...
public class DroneMoveForwardTest extends BaseActivityInstrumentationTestCase<ScriptActivity> {
	private static final int X_TO_CHANGE = 17;

	private Project project;
	private ChangeXByNBrick changeXByNBrick;

	public DroneMoveForwardTest() {
		super(ScriptActivity.class);
	}

	@Override
	public void setUp() throws Exception {
		UtilFile.deleteStandardDroneProjectAndReCreate(getInstrumentation().getTargetContext());
		super.setUp();
	}
