...
public class DroneSettingsActivityTest extends BaseActivityInstrumentationTestCase<MainMenuActivity> {
	...
	public void testDroneConnectToDroneDialog() {
		assertTrue("DroneBricks not activated!", SettingsActivity.isDroneSharedPreferenceEnabled(getActivity(), false));
	...
	public void testDroneSettingsActivity() {
		...
		assertTrue("Wrong Settings set, altitude limit should be 3 meter", solo.searchText(solo.getString(R.string.drone_set_altitude_max_3m)));
		assertTrue("Wrong Settings set, vertical speed limit should be 3 meter", solo.searchText(solo.getString(R.string.drone_set_vertical_indoor)));
		assertTrue("Wrong Settings set, rotation speed limit should be 3 meter", solo.searchText(solo.getString(R.string.drone_set_rotation_indoor)));
		assertTrue("Wrong Settings set, tilt limit should be 3 meter", solo.searchText(solo.getString(R.string.drone_set_tilt_indoor)));

		solo.clickOnText(solo.getString(R.string.brick_drone_set_config));
		solo.waitForText(solo.getString(R.string.brick_drone_set_config));
		solo.clickOnText(solo.getString(R.string.drone_config_outdoor_without_hull));
		assertTrue("Wrong Settings set, altitude limit should be 3 meter", solo.searchText(solo.getString(R.string.drone_set_altitude_max_3m)));
		assertTrue("Wrong Settings set, vertical speed limit should be 3 meter", solo.searchText(solo.getString(R.string.drone_set_vertical_outdoor)));
		assertTrue("Wrong Settings set, rotation speed limit should be 3 meter", solo.searchText(solo.getString(R.string.drone_set_rotation_outdoor)));
		assertTrue("Wrong Settings set, tilt limit should be 3 meter", solo.searchText(solo.getString(R.string.drone_set_tilt_outdoor)));
