...
public class ChangeYByBrickTest extends AndroidTestCase {
	...
	public void testBoundaryPositions() {
		...
		assertEquals("ChangeYByBrick failed to place Sprite at maximum y integer value", Integer.MAX_VALUE, sprite.getYPosition());
		...
		assertEquals("ChangeYByBrick failed to place Sprite at minimum y integer value", Integer.MIN_VALUE, sprite.getYPosition());
