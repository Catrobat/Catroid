...
public class SetYBrickTest extends AndroidTestCase {
	...
	public void testBoundaryPositions() {
		...
		assertEquals("SetYBrick failed to place Sprite at maximum y integer value", Integer.MAX_VALUE, sprite.getYPosition());

		brick = new SetYBrick(sprite, Integer.MIN_VALUE);
		brick.execute();

		assertEquals("SetYBrick failed to place Sprite at minimum y integer value", Integer.MIN_VALUE, sprite.getYPosition());
	}
}
