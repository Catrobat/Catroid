...
public class ChangeXByBrickTest extends AndroidTestCase {
	...
	public void testBoundaryPositions() {
		...
		assertEquals("ChangeXByBrick failed to place Sprite at maximum x integer value", Integer.MAX_VALUE, sprite.getXPosition());
		...
		assertEquals("ChangeXByBrick failed to place Sprite at minimum x integer value", Integer.MIN_VALUE, sprite.getXPosition());
