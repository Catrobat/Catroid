...
public class SetXBrickTest extends AndroidTestCase {
	...
	public void testBoundaryPositions() {
		...
		assertEquals("SetXBrick failed to place Sprite at maximum x integer value", Integer.MAX_VALUE, sprite.getXPosition());

		brick = new SetXBrick(sprite, Integer.MIN_VALUE);
		brick.execute();

		assertEquals("SetXBrick failed to place Sprite at minimum x integer value", Integer.MIN_VALUE, sprite.getXPosition());
	}
}
