...
public class ThinkBrickTest extends AndroidTestCase {

	public void testNormalBehavior() {
		Sprite sprite = new Sprite("testSprite");
		ThinkBrick thinkBrick = new ThinkBrick(sprite);
		...
		String brickText = (String) TestUtils.getPrivateField("text", thinkBrick, false);
		String speechBubbleText = (String) TestUtils.getPrivateField("speechBubbleText", speechBubble, false);
		Sprite brickSprite = (Sprite) TestUtils.getPrivateField("sprite", thinkBrick, false);
	...
	public void testNullSprite() {
		ThinkBrick thinkBrick = new ThinkBrick(null);
		try {
			thinkBrick.execute();
	...
	public void testExecuteWithText() {
		...
		ThinkBrick thinkBrick = new ThinkBrick(sprite, inputText);
