...
import org.catrobat.catroid.retrofit.models.OAuthToken
import org.catrobat.catroid.web.ServerAuthenticationConstants.SERVER_RESPONSE_TOKEN_OK
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class OAuthViewModel(private val webServer: WebService) {
    ...
    fun oAuthLogin(id_token: String, resource_owner: String) {
        val oAuthLoginCall: Call<LoginResponse> = webServer.oAuthLogin(
            OAuthToken(id_token, resource_owner))
    ...
    companion object {
        private val TAG = OAuthViewModel::class.java.simpleName
    }
}
