...
object GlobalProjectDownloadQueue {
    ...
    class ProjectDownloadQueue : ProjectDownloader.ProjectDownloadQueue {
        ...
        override fun alreadyInQueue(projectName: String): Boolean =
            projectNameSet.contains(projectName.lowercase(Locale.getDefault()))

        @Synchronized
        override fun enqueue(projectName: String) {
            projectNameSet = projectNameSet.plus(projectName.lowercase(Locale.getDefault()))
        }

        @Synchronized
        override fun finished(projectName: String) {
            projectNameSet = projectNameSet.minus(projectName.lowercase(Locale.getDefault()))
        }
    }
}
