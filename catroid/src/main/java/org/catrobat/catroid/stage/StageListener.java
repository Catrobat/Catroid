...
public class StageListener implements ApplicationListener {
	...
	public boolean makeScreenshot(boolean manual) {
		makeScreenshot = true;
		while (makeScreenshot) {
			Thread.yield();
		}
		String screenshotName = manual ? SCREENSHOT_MANUAL_FILE_NAME : SCREENSHOT_AUTOMATIC_FILE_NAME;
		return saveScreenshot(this.screenshot, screenshotName);
	}
