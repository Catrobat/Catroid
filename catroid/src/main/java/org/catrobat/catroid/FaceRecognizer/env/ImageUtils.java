...
public class ImageUtils {
    ...
    static {
        try {
            ...
            Log.w("ImageUtils", String.format("Native library not found, native RGB -> YUV conversion may be unavailable."));
        }
    }
    ...
    public static void convertYUV420SPToARGB8888(
        ...
        if (useNativeConversion) {
            try {
                ...
                Log.w("ImageUtils", String.format("Native YUV420SP -> RGB implementation not found, falling back to Java implementation"));
    ...
    public static void convertYUV420ToARGB8888(
        ...
        if (useNativeConversion) {
            try {
                ...
                Log.w("ImageUtils", String.format("Native YUV420 -> RGB implementation not found, falling back to Java implementation"));
                useNativeConversion = false;
            }
        }
    ...
    public static void prewhiten(float[] input, FloatBuffer output) {
        if (useNativeConversion) {
            try {
                ...
                Log.w("ImageUtils", String.format("Native prewhiten implementation not found, falling back to Java implementation"));
                useNativeConversion = false;
            }
        }
