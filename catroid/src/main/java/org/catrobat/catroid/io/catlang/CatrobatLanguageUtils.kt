...
object CatrobatLanguageUtils {
    ...
    @JvmStatic
    fun getAndValidateDoubleFromString(value: String): Double = getAndValidateStringContent(value).toDouble()

    @JvmStatic
    fun getAndValidateBooleanFromString(value: String): Boolean = getAndValidateStringContent(value).toBoolean()

    @JvmStatic
    fun getAndValidateIntFromString(value: String): Int = getAndValidateStringContent(value).toInt()
    ...
    private fun formatAndEscapeString(
        ...
        enclosingEndString: String? = null
    ): String {
        var escapedString = ""
        if (string != null) {
    ...
    @JvmStatic
    fun getIndentionByLevel(level: IndentionLevel): String = getIndention(level.ordinal + 1)
