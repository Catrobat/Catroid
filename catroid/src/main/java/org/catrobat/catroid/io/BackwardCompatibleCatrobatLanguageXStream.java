...
public class BackwardCompatibleCatrobatLanguageXStream extends XStream {
	...
	private void initializeBrickInfoMap() {
		...
		brickInfo = new BrickInfo(SetSpeakingLanguageBrick.class.getSimpleName());
		brickInfoMap.put("setSpeakingLanguageBrick", brickInfo);
		...
		brickInfo = new BrickInfo(EmptyEventBrick.class.getSimpleName());
		brickInfoMap.put("emptyEventBrick", brickInfo);
