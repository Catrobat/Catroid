...
public class SetPenSizeBrick extends FormulaBrick {
	...
	public SetPenSizeBrick() {
		addAllowedBrickField(BrickField.PEN_SIZE, R.id.brick_set_pen_size_edit_text, "pen size");
	}
	...
	public void addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
		sequence.addAction(sprite.getActionFactory()
				.createSetPenSizeAction(sprite, sequence, getFormulaWithBrickField(BrickField.PEN_SIZE)));
	}
}
