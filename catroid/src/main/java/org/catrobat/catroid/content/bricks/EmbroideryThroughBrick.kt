...
class EmbroideryThroughBrick() : FormulaBrick() {

    init {
        addAllowedBrickField(
            BrickField.X_POSITION,
            R.id.brick_embroidery_through_x1_edit_text
        )
        addAllowedBrickField(
            BrickField.Y_POSITION,
            R.id.brick_embroidery_through_y1_edit_text
        )
        addAllowedBrickField(
            BrickField.X_DESTINATION,
            R.id.brick_embroidery_through_x2_edit_text
        )
        addAllowedBrickField(
            BrickField.Y_DESTINATION,
            R.id.brick_embroidery_through_y2_edit_text
        )
    }
    ...
    override fun getViewResource(): Int {
        return R.layout.brick_embroidery_through
    }
