...
class PhiroMotorMoveForwardAction : TemporalAction() {
    private var motorEnum: PhiroMotorMoveForwardBrick.Motor? = null
    ...
    override fun update(percent: Float) {
        ...
        val phiro = btService.getDevice(BluetoothDevice.PHIRO)
            ?: return
        when (motorEnum) {
            PhiroMotorMoveForwardBrick.Motor.MOTOR_LEFT -> phiro.moveLeftMotorForward(speedValue)
            PhiroMotorMoveForwardBrick.Motor.MOTOR_RIGHT -> phiro.moveRightMotorForward(speedValue)
            PhiroMotorMoveForwardBrick.Motor.MOTOR_BOTH -> {
    ...
    fun setMotorEnum(motorEnum: PhiroMotorMoveForwardBrick.Motor?) {
