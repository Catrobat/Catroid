...
class ReplaceItemInUserListAction : TemporalAction() {
    ...
    override fun update(percent: Float) {
        ...
        val value =
            if (formulaItemToInsert == null) 0.0 else formulaItemToInsert!!.interpretObject(scope)

        var indexToReplace = try {
            if (formulaIndexToReplace == null) 1
            else formulaIndexToReplace!!.interpretInteger(scope)
