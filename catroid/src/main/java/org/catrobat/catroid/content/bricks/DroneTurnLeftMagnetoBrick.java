...
public class DroneTurnLeftMagnetoBrick extends FormulaBrick {
	...
	public void showFormulaEditorToEditFormula(View view) {
		switch (view.getId()) {
			case R.id.brick_drone_turn_left_magneto_edit_text_power:
				FormulaEditorFragment.showFragment(view, this, BrickField.DRONE_POWER_IN_PERCENT);
				break;
			case R.id.brick_drone_turn_left_magneto_edit_text_second:
			default:
	...
	public View getView(Context context, int brickId, BaseAdapter adapter) {
		...
		getFormulaWithBrickField(BrickField.DRONE_TIME_TO_FLY_IN_SECONDS)
				.setTextFieldId(R.id.brick_drone_turn_left_magneto_edit_text_second);
		getFormulaWithBrickField(BrickField.DRONE_TIME_TO_FLY_IN_SECONDS).refreshTextField(view);
		editTime.setOnClickListener(this);

		TextView editPower = (TextView) view.findViewById(R.id.brick_drone_turn_left_magneto_edit_text_power);
		getFormulaWithBrickField(BrickField.DRONE_POWER_IN_PERCENT)
				.setTextFieldId(R.id.brick_drone_turn_left_magneto_edit_text_power);
