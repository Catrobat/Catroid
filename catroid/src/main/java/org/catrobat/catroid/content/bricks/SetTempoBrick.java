...
public class SetTempoBrick extends FormulaBrick {
	...
	public SetTempoBrick() {
		addAllowedBrickField(BrickField.TEMPO, R.id.brick_set_tempo_edit_text, "tempo");
	}

	public SetTempoBrick(int tempo) {
		this(new Formula(tempo));
	}

	public SetTempoBrick(Formula formula) {
		this();
		setFormulaWithBrickField(BrickField.TEMPO, formula);
	}
