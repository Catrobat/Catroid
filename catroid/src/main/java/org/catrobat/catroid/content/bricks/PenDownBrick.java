...
public class PenDownBrick extends BrickBaseType {
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			View layout = view.findViewById(R.id.brick_pen_down_layout);
			Drawable background = layout.getBackground();
			background.setAlpha(alphaValue);

			TextView penLookLabel = (TextView) view.findViewById(R.id.brick_pen_down_text_view);
			penLookLabel.setTextColor(penLookLabel.getTextColors().withAlpha(alphaValue));
