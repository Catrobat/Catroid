...
public class DroneMoveDownBrick extends FormulaBrick {
	...
	public DroneMoveDownBrick() {
		addAllowedBrickField(BrickField.DRONE_TIME_TO_FLY_IN_SECONDS, R.id.brick_drone_move_down_edit_text_second, "seconds");
		addAllowedBrickField(BrickField.DRONE_POWER_IN_PERCENT, R.id.brick_drone_move_down_edit_text_power, "power percentage");
	}
	...
	protected Map.Entry<String, String> getArgumentByCatlangName(String name) {
		if (name.equals(DIRECTION_CATLANG_PARAMETER_NAME)) {
			return CatrobatLanguageUtils.getCatlangArgumentTuple(DIRECTION_CATLANG_PARAMETER_NAME, "down");
		}
