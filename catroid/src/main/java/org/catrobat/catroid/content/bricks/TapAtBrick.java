...
@CatrobatLanguageBrick(command = "Single tap at")
public class TapAtBrick extends VisualPlacementBrick {

	private static final long serialVersionUID = 1L;

	public TapAtBrick() {
		addAllowedBrickField(BrickField.X_POSITION, R.id.brick_tap_at_edit_text_x, "x");
		addAllowedBrickField(BrickField.Y_POSITION, R.id.brick_tap_at_edit_text_y, "y");
	}
