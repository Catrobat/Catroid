...
class ShowTextColorSizeAlignmentAction : TemporalAction() {
    ...
    override fun begin() {
        try {
            ...
            val relativeTextSize = relativeTextSize!!.interpretFloat(scope) / 100
            ...
            if (StageActivity.stageListener != null) {
                ...
                val dummyActor = ShowTextActor(
                    ...
                    0, relativeTextSize, color, scope!!.sprite, alignment
                )
    ...
    companion object {
        val TAG = ShowTextColorSizeAlignmentAction::class.java.simpleName
    }
}