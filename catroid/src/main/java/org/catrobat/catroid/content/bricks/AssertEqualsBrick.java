...
public class AssertEqualsBrick extends FormulaBrick {
	...
	public BrickBaseType clone() throws CloneNotSupportedException {
		...
		if (ProjectManager.getInstance().getCurrentProject() != null) {
			DataContainer dataContainer = ProjectManager.getInstance().getCurrentProject().getDefaultScene()
					.getDataContainer();
			dataContainer.addUserVariable(new UserVariable(AssertEqualsBrick.ACTUAL_VARIABLE_NAME));
			dataContainer.addUserVariable(new UserVariable(AssertEqualsBrick.EXPECTED_VARIABLE_NAME));
			dataContainer.addUserVariable(new UserVariable(AssertEqualsBrick.READY_VARIABLE_NAME));
		}
		return clone;
	}
	...
	public List<ScriptSequenceAction> addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
		...
		sequence.addAction(sprite.getActionFactory().createAssertEqualsAction(sprite,
				...
				dataContainer.getProjectUserVariable(AssertEqualsBrick.ACTUAL_VARIABLE_NAME),
				dataContainer.getProjectUserVariable(AssertEqualsBrick.EXPECTED_VARIABLE_NAME),
				dataContainer.getProjectUserVariable(AssertEqualsBrick.READY_VARIABLE_NAME)));
		return null;
	}
}
