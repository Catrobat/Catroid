...
public class DroneMoveLeftBrick extends FormulaBrick {
	...
	public DroneMoveLeftBrick() {
		addAllowedBrickField(BrickField.DRONE_TIME_TO_FLY_IN_SECONDS, R.id.brick_drone_move_left_edit_text_second, "seconds");
		addAllowedBrickField(BrickField.DRONE_POWER_IN_PERCENT, R.id.brick_drone_move_left_edit_text_power, "power percentage");
	}
	...
	protected Map.Entry<String, String> getArgumentByCatlangName(String name) {
		if (name.equals(DIRECTION_CATLANG_PARAMETER_NAME)) {
			return CatrobatLanguageUtils.getCatlangArgumentTuple(DIRECTION_CATLANG_PARAMETER_NAME, "left");
		}
