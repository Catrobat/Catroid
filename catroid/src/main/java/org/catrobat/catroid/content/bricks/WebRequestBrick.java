...
public class WebRequestBrick extends UserVariableBrick {
	...
	public WebRequestBrick(String value) {
	...
	public void addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
		sequence.addAction(sprite.getActionFactory().createWebRequestAction(sprite,
