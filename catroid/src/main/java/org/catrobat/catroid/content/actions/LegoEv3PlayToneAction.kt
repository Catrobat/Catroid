...
class LegoEv3PlayToneAction : TemporalAction() {
    private var hertz: Formula? = null
    private var durationInSeconds: Formula? = null
    private var volumeInPercent: Formula? = null
    ...
    fun setVolumeInPercent(volumeInPercent: Formula?) {
