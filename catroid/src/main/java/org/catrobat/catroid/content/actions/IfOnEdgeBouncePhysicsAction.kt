...
class IfOnEdgeBouncePhysicsAction : TemporalAction() {
    ...
    private val virtualScreenWidth = inject(ProjectManager::class.java).value.currentProject.xmlHeader.virtualScreenWidth
    private val vsHeight = inject(ProjectManager::class.java).value.currentProject.xmlHeader.virtualScreenHeight
