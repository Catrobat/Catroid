...
public class InsertItemIntoUserListBrick extends UserListBrick {
	...
	public Brick clone() throws CloneNotSupportedException {
		InsertItemIntoUserListBrick clone = (InsertItemIntoUserListBrick) super.clone();
		clone.initializeBrickFields(getFormulaWithBrickField(BrickField.INSERT_ITEM_INTO_USERLIST_VALUE).clone(),
