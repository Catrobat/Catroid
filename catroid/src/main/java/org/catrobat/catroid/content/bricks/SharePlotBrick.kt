...
class SharePlotBrick() : FormulaBrick() {
    ...
    init {
        addAllowedBrickField(
            BrickField.WRITE_FILENAME, R.id.brick_share_plot_edit_text
        )
    }

    override fun getViewResource(): Int = R.layout.brick_share_plot

    override fun addActionToSequence(sprite: Sprite, sequence: ScriptSequenceAction) {
        sequence.addAction(
            sprite.actionFactory.createSharePlotAction(
