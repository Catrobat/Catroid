...
import org.catrobat.catroid.content.actions.TapSpriteAction;
...
public class ActionFactory extends Actions {
	...
	public Action createTapSpriteAction(Sprite sprite) {
		TapSpriteAction action = Actions.action(TapSpriteAction.class);
		action.setSprite(sprite);
