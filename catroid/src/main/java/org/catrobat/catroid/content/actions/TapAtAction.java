...
public class TapAtAction extends TemporalAction {
	...
	protected void update(float percent) {
		try {
			float x = tapX.interpretInteger(sprite);
			float y = tapY.interpretInteger(sprite);
			...
			stage.touchDown((int) touchCoords.x, (int) touchCoords.y, 0, 0);
			stage.touchUp((int) touchCoords.x, (int) touchCoords.y, 0, 0);
