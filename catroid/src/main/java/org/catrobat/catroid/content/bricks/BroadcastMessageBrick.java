...
public abstract class BroadcastMessageBrick extends BrickBaseType implements
	...
	public void onNewOptionSelected(Integer spinnerId) {
		...
		builder.setHint(activity.getString(R.string.dialog_broadcast_message_name))
				...
				.setText(
						new UniqueNameProvider().getUniqueName(
								activity.getString(R.string.default_broadcast_message_name),
								projectManager.getCurrentProject().getBroadcastMessageContainer()
	...
	public void addItem(String item) {
		if (inject(ProjectManager.class).getValue()
				.getCurrentProject().getBroadcastMessageContainer().addBroadcastMessage(item)) {
	...
	public boolean removeItem(String item) {
		return inject(ProjectManager.class).getValue()
				.getCurrentProject().getBroadcastMessageContainer().removeBroadcastMessage(item);
	}
