...
public abstract class BroadcastMessageBrick extends BrickBaseType implements
	...
	public View getView(Context context) {
		...
		List<String> messages = inject(ProjectManager.class).getValue().getCurrentProject()
	...
	public void onNewOptionSelected(Integer spinnerId) {
		...
		builder.setHint(activity.getString(R.string.dialog_broadcast_message_name))
				...
				.setText(new UniqueNameProvider().getUniqueName(activity.getString(R.string.default_broadcast_message_name), inject(ProjectManager.class).getValue().getCurrentProject().getBroadcastMessageContainer().getBroadcastMessages()))
	...
	public void addItem(String item) {
		if (inject(ProjectManager.class).getValue().getCurrentProject().getBroadcastMessageContainer().addBroadcastMessage(item)) {
	...
	public boolean removeItem(String item) {
		return inject(ProjectManager.class).getValue().getCurrentProject().getBroadcastMessageContainer().removeBroadcastMessage(item);
	}
