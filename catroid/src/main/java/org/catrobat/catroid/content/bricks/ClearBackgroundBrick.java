...
public class ClearBackgroundBrick extends BrickBaseType {
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			View layout = view.findViewById(R.id.brick_clear_background_layout);
			Drawable background = layout.getBackground();
			background.setAlpha(alphaValue);

			TextView clearBackgroundLabel = (TextView) view.findViewById(R.id.brick_clear_background_text_view);
			clearBackgroundLabel.setTextColor(clearBackgroundLabel.getTextColors().withAlpha(alphaValue));
