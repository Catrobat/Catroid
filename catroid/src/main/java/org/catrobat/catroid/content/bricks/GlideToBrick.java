...
public class GlideToBrick extends FormulaBrick {
	...
	public View getPrototypeView(Context context) {
		...
		textX.setText(FormulaBrick.getStringFromFloatForBrickView(BrickValues.X_POSITION));
		textY.setText(FormulaBrick.getStringFromFloatForBrickView(BrickValues.Y_POSITION));
		textDuration.setText(FormulaBrick.getStringFromFloatForBrickView(BrickValues.DURATION));
