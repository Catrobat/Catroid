...
@CatrobatLanguageBrick(command = "Glide to")
public class GlideToBrick extends VisualPlacementBrick {

	private static final long serialVersionUID = 1L;

	public GlideToBrick() {
		addAllowedBrickField(BrickField.X_DESTINATION, R.id.brick_glide_to_edit_text_x, "x");
		addAllowedBrickField(BrickField.Y_DESTINATION, R.id.brick_glide_to_edit_text_y, "y");
		addAllowedBrickField(BrickField.DURATION_IN_SECONDS, R.id.brick_glide_to_edit_text_duration, "seconds");
	}
