...
public class IfOnEdgeBounceAction extends TemporalAction {
	...
	protected void update(float percent) {
		...
		int halfVirtualScreenWidth = projectManager.getCurrentProject().getXmlHeader().virtualScreenWidth / 2;
		int halfVirtualScreenHeight = projectManager.getCurrentProject().getXmlHeader().virtualScreenHeight / 2;
		...
		sprite.look.setMotionDirectionInUserInterfaceDimensionUnit(newDirection);
