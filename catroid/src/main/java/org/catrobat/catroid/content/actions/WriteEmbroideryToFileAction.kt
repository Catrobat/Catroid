...
class WriteEmbroideryToFileAction : BaseFileStorageAction() {

    override var formula: Formula? = null
    override var scope: Scope? = null
    override val fileExtension = Constants.EMBROIDERY_FILE_EXTENSION
    override val isReadAction = false
    override val errorMessageResId = R.string.error_embroidery_file_write

    override fun checkIfDataIsReady(): Boolean =
        stageListener.embroideryPatternManager.validPatternExists()
