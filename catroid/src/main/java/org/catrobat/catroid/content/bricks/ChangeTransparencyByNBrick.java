...
@CatrobatLanguageBrick(command = "Change transparency by")
public class ChangeTransparencyByNBrick extends FormulaBrick {

	private static final long serialVersionUID = 1L;

	public ChangeTransparencyByNBrick() {
		addAllowedBrickField(BrickField.TRANSPARENCY_CHANGE, R.id.brick_change_transparency_edit_text, "value");
	}
	...
	public void addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
		sequence.addAction(sprite.getActionFactory()
				.createChangeTransparencyByNAction(sprite, sequence,
