...
public class SetTextBrick extends FormulaBrick implements View.OnClickListener {
	...
	public View getPrototypeView(Context context) {
		...
		posX.setText(FormulaBrick.getStringFromFloatForBrickView(BrickValues.X_POSITION));
		posY.setText(FormulaBrick.getStringFromFloatForBrickView(BrickValues.Y_POSITION));
