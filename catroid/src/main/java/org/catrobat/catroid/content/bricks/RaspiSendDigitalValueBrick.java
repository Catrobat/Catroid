...
public class RaspiSendDigitalValueBrick extends FormulaBrick {
	...
	public RaspiSendDigitalValueBrick() {
		addAllowedBrickField(BrickField.RASPI_DIGITAL_PIN_NUMBER, R.id.brick_raspi_set_digital_pin_edit_text, "Raspberry Pi pin");
		addAllowedBrickField(BrickField.RASPI_DIGITAL_PIN_VALUE, R.id.brick_raspi_set_digital_value_edit_text, "value");
	}
