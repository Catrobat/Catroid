...
import static org.catrobat.catroid.ui.recyclerview.adapter.BrickAdapter.DISABLED_BRICK_ALPHA;
...
public class EmptyEventBrick extends ScriptBrickBaseType {
	...
	public Brick clone() throws CloneNotSupportedException {
		EmptyEventBrick clone = (EmptyEventBrick) super.clone();
		clone.script = (EmptyScript) script.clone();
