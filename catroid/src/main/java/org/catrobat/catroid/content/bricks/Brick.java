...
public interface Brick extends Serializable, Cloneable {
	...
	enum BrickField {
		...
		VARIABLE_CHANGE, PEN_SIZE, IF_CONDITION, IF_SIMPLE_FIRST_CONDITION, IF_SIMPLE_SECOND_CONDITION, IF_SIMPLE_OPERATOR_CONDITION,
		TIMES_TO_REPEAT, VIBRATE_DURATION_IN_SECONDS, USER_BRICK, NOTE, SPEAK,
