...
public interface Brick extends Serializable, Cloneable {
	...
	enum BrickField implements FormulaField {
		...
		VARIABLE_CHANGE, WEB_REQUEST, LOOK_REQUEST, BACKGROUND_REQUEST, WRITE_FILENAME, READ_FILENAME,
		...
		ASK_QUESTION, NFC_NDEF_MESSAGE, ASK_SPEECH_QUESTION, LOOK_INDEX,
	...
	@IntDef({TEXT_TO_SPEECH, BLUETOOTH_LEGO_NXT, PHYSICS, FACE_DETECTION, ARDRONE_SUPPORT,
			...
			STORAGE_WRITE, STORAGE_READ, SPEECH_RECOGNITION})
	@interface Resources {
	}
