...
public interface Brick extends Serializable, Cloneable {
	...
	enum BrickField implements FormulaField {
		...
		TEMPO_CHANGE, BEATS_TO_PAUSE, NOTE_TO_PLAY, BEATS_TO_PLAY_NOTE, OPEN_URL,
		ASK_CHAT_QUESTION, RESPONSE_CHAT_QUESTION,PLAY_DRUM,
		PLAY_SOUND_AT,
	...
	@IntDef({TEXT_TO_SPEECH, BLUETOOTH_LEGO_NXT, PHYSICS, FACE_DETECTION,
			...
			SPEECH_RECOGNITION, TEXT_DETECTION, POSE_DETECTION, OBJECT_DETECTION,OBJECT_RECOGNITION,FACE_RECOGNITION})
	@interface Resources {
	}
	...
	int OBJECT_RECOGNITION = 29;
	int FACE_RECOGNITION = 30;
