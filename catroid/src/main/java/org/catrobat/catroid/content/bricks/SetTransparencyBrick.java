...
public class SetTransparencyBrick extends FormulaBrick {
	...
	public SetTransparencyBrick() {
		addAllowedBrickField(BrickField.TRANSPARENCY, R.id.brick_set_transparency_to_edit_text, "transparency percentage");
	}

	public SetTransparencyBrick(double transparency) {
		this(new Formula(transparency));
	}
	...
	public void addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
		sequence.addAction(sprite.getActionFactory()
				.createSetTransparencyAction(sprite, sequence,
