...
class TurnRightSpeedAction : TemporalAction() {
    private var scope: Scope? = null
    private var physicsObject: PhysicsObject? = null
    private var speed: Formula? = null
    override fun update(percent: Float) {
        val newSpeed: Float = try {
            if (speed == null) java.lang.Float.valueOf(0f) else speed!!.interpretFloat(scope)
        ...
        physicsObject!!.rotationSpeed = -newSpeed
    }
