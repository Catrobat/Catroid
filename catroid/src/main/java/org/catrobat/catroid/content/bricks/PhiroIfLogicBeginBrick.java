...
public class PhiroIfLogicBeginBrick extends IfLogicBeginBrick implements OnItemSelectedListener {
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		DynamicTextSizeArrayAdapter<CharSequence> phiroProSensorAdapter = new DynamicTextSizeArrayAdapter(context,
				android.R.layout.simple_spinner_item, context.getResources().getStringArray(R.array.brick_phiro_select_sensor_spinner));
