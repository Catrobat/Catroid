...
public class IfThenLogicBeginSimpleBrick extends IfLogicBeginSimpleBrick implements NestingBrick {
	private static final long serialVersionUID = 1L;
	protected transient IfThenLogicEndSimpleBrick ifEndBrick;

	public IfThenLogicBeginSimpleBrick(Formula simpleCondition, Formula firstCondition,
	...
	public void setIfThenEndSimpleBrick(IfThenLogicEndSimpleBrick ifEndBrick) {
		this.ifEndBrick = ifEndBrick;
	}

	@Override
	public Brick clone() {
		return new IfThenLogicBeginSimpleBrick(getFormulaWithBrickField(BrickField.IF_CONDITION).clone(),
	...
	public void initialize() {
		ifEndBrick = new IfThenLogicEndSimpleBrick(this);
	}
	...
	public Brick copyBrickForSprite(Sprite sprite) {
		IfThenLogicBeginSimpleBrick copyBrick = (IfThenLogicBeginSimpleBrick) clone();
	...
	public IfThenLogicEndSimpleBrick getIfThenEndSimpleBrick() {
		return ifEndBrick;
	}
}
