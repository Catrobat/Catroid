...
public class DroneMoveBackwardBrick extends FormulaBrick {
	...
	public DroneMoveBackwardBrick() {
		addAllowedBrickField(BrickField.DRONE_TIME_TO_FLY_IN_SECONDS, R.id.brick_drone_move_backward_edit_text_second, "seconds");
		addAllowedBrickField(BrickField.DRONE_POWER_IN_PERCENT, R.id.brick_drone_move_backward_edit_text_power, "power percentage");
	}
