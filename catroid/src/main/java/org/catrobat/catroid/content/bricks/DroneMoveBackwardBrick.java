...
public class DroneMoveBackwardBrick extends FormulaBrick {
	...
	public View getView(Context context, int brickId, BaseAdapter adapter) {
		...
		getFormulaWithBrickField(BrickField.DRONE_POWER_IN_PERCENT)
				.setTextFieldId(R.id.brick_drone_move_backward_edit_text_power);
	...
	public View getPrototypeView(Context context) {
		...
		TextView textPower = (TextView) prototypeView.findViewById(R.id
				.brick_drone_move_backward_edit_text_power);
