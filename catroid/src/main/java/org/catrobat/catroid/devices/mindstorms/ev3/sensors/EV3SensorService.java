...
public class EV3SensorService implements CatroidService, SharedPreferences.OnSharedPreferenceChangeListener {
	...
	private boolean isChangedPreferenceASensorPreference(String preference) {
		return (preference.equals(SettingsFragment.EV3_SENSOR_1)
				|| preference.equals(SettingsFragment.EV3_SENSOR_2)
				|| preference.equals(SettingsFragment.EV3_SENSOR_3)
				|| preference.equals(SettingsFragment.EV3_SENSOR_4));
	}
