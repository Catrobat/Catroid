...
public class EV3CommandByte {
	...
	public enum EV3CommandByteCode {
		...
		INPUT_DEVICE_GET_FORMAT(0x02), INPUT_DEVICE_GET_TYPEMODE(0x04), INPUT_DEVICE_SETUP(0x09),
		INPUT_DEVICE_GET_RAW(0x0B), INPUT_DEVICE_GET_CONNECTION(0x0C), INPUT_DEVICE_STOP_ALL(0x0D),
