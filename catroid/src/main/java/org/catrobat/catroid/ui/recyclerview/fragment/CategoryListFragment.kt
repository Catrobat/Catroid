...
class CategoryListFragment : Fragment(), CategoryListRVAdapter.OnItemClickListener {
    ...
    var chosenItem: CategoryListItem? = null
    override fun onItemClick(item: CategoryListItem?) {
        when (item!!.type) {
            ...
            CategoryListRVAdapter.DEFAULT -> if (LIST_FUNCTIONS.contains(
                    item.nameResId
                )
            ) {
                ...
                val formulaEditorFragment =
                    requireFragmentManager().findFragmentByTag(FormulaEditorFragment.FORMULA_EDITOR_FRAGMENT_TAG) as FormulaEditorFragment?
    ...
    fun getHelpUrl(tag: String?): String? {
        val language = getLanguage()
        when (tag) {
    ...
    fun getLanguage(): String {
        ...
        val mLocale: Locale
        mLocale = if (languageTag == SharedPreferenceKeys.DEVICE_LANGUAGE) {
            Locale.forLanguageTag(CatroidApplication.defaultSystemLanguage)
        } else {
            if (Arrays.asList(*SharedPreferenceKeys.LANGUAGE_TAGS)
        ...
        language = language + mLocale.language
        return language
    }
    ...
    private fun onUserListFunctionSelected(item: CategoryListItem?) {
        ...
        insertLastUserListToActiveFormula(item, projectUserList, spriteUserList, builder)
    }
    ...
    fun insertLastUserListToActiveFormula(
        ...
        if (spriteUserList.isEmpty() && projectUserList.isEmpty()) {
            showNewUserListDialog(categoryListItem, projectUserList, spriteUserList, builder)
            return
        }
    ...
    private fun showLegoSensorPortConfigDialog(itemNameResId: Int, @LegoSensorType type: Int) {
        LegoSensorPortConfigDialog.Builder(requireContext(), type, itemNameResId)
            .setPositiveButton(getString(R.string.ok)) { dialog: DialogInterface?, selectedPort: Int, selectedSensor: Enum<*>? ->
                ...
                val formulaEditor = requireFragmentManager()
                    .findFragmentByTag(FormulaEditorFragment.FORMULA_EDITOR_FRAGMENT_TAG) as FormulaEditorFragment?
                val sensorPortsId =
    ...
    private fun showSelectSpriteDialog() {
        ...
        AlertDialog.Builder(requireContext())
            ...
            .setItems(selectableSpriteNames) { dialog: DialogInterface?, which: Int ->
    ...
    private fun initializeAdapter() {
        ...
        items = if (OBJECT_TAG == argument) {
            ...
            throw IllegalArgumentException("Argument for CategoryListFragent null or unknown: $argument")
        }
    ...
    ): List<CategoryListItem> = toCategoryListItems(nameResIds, paramResIds,
    ...
    companion object {
        ...
        private val OBJECT_GENERAL_PROPERTIES = Arrays.asList(
        ...
        private val OBJECT_LOOK = Arrays.asList(
        ...
        private val OBJECT_BACKGROUND = Arrays.asList(
        ...
        private val OBJECT_PHYSICAL_1 = Arrays.asList(
        ...
        private val OBJECT_PHYSICAL_2 = Arrays.asList(
        ...
        private val MATH_FUNCTIONS = Arrays.asList(
        ...
        private val MATH_PARAMS = Arrays.asList(
        ...
        private val STRING_FUNCTIONS = Arrays.asList(
        ...
        private val STRING_PARAMS = Arrays.asList(
        ...
        private val LIST_FUNCTIONS = Arrays.asList(
        ...
        private val LIST_PARAMS = Arrays.asList(
        ...
        private val LOGIC_BOOL = Arrays.asList(
        ...
        private val LOGIC_COMPARISION = Arrays.asList(
        ...
        private val SENSORS_COLOR_AT_XY = Arrays.asList(R.string.formula_editor_sensor_color_at_x_y)
        private val SENSORS_COLOR_AT_XY_PARAMS =
            Arrays.asList(R.string.formula_editor_sensor_color_at_x_y_parameter)
        private val SENSORS_COLOR_EQUALS_COLOR =
            Arrays.asList(R.string.formula_editor_sensor_color_equals_color)
        private val SENSORS_COLOR_EQUALS_COLOR_PARAMS =
            Arrays.asList(R.string.formula_editor_sensor_color_equals_color_parameter)
        private val SENSORS_ACCELERATION = Arrays.asList(
        ...
        private val SENSORS_INCLINATION = Arrays.asList(
        ...
        private val SENSORS_GPS = Arrays.asList(
        ...
        private val SENSORS_TOUCH = Arrays.asList(
        ...
        private val SENSORS_TOUCH_PARAMS = Arrays.asList(
            R.string.formula_editor_function_no_parameter,
            R.string.formula_editor_function_no_parameter,
            R.string.formula_editor_function_no_parameter,
        ...
        private val SENSORS_FACE_DETECTION = Arrays.asList(
        ...
        private val SENSORS_FACE_DETECTION_PARAMS = Arrays.asList(
            R.string.formula_editor_function_no_parameter,
            R.string.formula_editor_function_no_parameter,
            R.string.formula_editor_function_no_parameter,
            R.string.formula_editor_function_no_parameter,
        ...
        private val SENSORS_POSE_DETECTION = Arrays.asList(
        ...
        private val SENSORS_POSE_DETECTION_PARAMS = Arrays.asList(
            R.string.formula_editor_function_no_parameter,
            R.string.formula_editor_function_no_parameter,
            R.string.formula_editor_function_no_parameter,
            R.string.formula_editor_function_no_parameter,
        ...
        private val SENSORS_POSE_DETECTION_HUAWEI = Arrays.asList(
        ...
        private val SENSORS_POSE_DETECTION_PARAMS_HUAWEI = Arrays.asList(
            R.string.formula_editor_function_no_parameter,
            R.string.formula_editor_function_no_parameter,
            R.string.formula_editor_function_no_parameter,
            R.string.formula_editor_function_no_parameter,
        ...
        private val SENSORS_TEXT_RECOGNITION = Arrays.asList(
        ...
        private val SENSORS_TEXT_RECOGNITION_PARAMS = Arrays.asList(
            R.string.formula_editor_function_no_parameter,
            R.string.formula_editor_function_no_parameter,
        ...
        private val SENSORS_NXT = Arrays.asList(
        ...
        private val SENSORS_EV3 = Arrays.asList(
        ...
        private val SENSORS_PHIRO = Arrays.asList(
        ...
        private val SENSORS_ARDUINO = Arrays.asList(
        ...
        private val SENSORS_ARDUINO_PARAMS = Arrays.asList(
            R.string.formula_editor_function_pin_default_parameter,
            R.string.formula_editor_function_pin_default_parameter
        )
        private val SENSORS_DRONE = Arrays.asList(
        ...
        private val SENSORS_NFC = Arrays.asList(
            R.string.formula_editor_nfc_tag_id,
            R.string.formula_editor_nfc_tag_message
        )
        private val SENSORS_CAST_GAMEPAD = Arrays.asList(
        ...
        private fun getSharedPreferences(context: Context): SharedPreferences = PreferenceManager
