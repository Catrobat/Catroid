...
import org.catrobat.catroid.ui.controller.ActionBarStateManager
import org.catrobat.catroid.ui.settingsfragments.AccessibilityProfile
import org.koin.java.KoinJavaComponent.inject

class HelpBrickFragment(val title: String) : ListFragment() {
    ...
    private val actionBarStateManager: ActionBarStateManager = ActionBarStateManager(title)
    ...
    override fun onResume() {
        super.onResume()
        setupSelectedBrickCategory()
        actionBarStateManager.setUpActionAndBottomBar(activity as AppCompatActivity)
    }

    override fun onDestroy() {
        super.onDestroy()
        actionBarStateManager.restoreOldState(activity as AppCompatActivity)
    }
