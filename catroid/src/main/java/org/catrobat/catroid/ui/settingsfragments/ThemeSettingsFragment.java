...
public class ThemeSettingsFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
	...
	public static final String TAG = ThemeSettingsFragment.class.getSimpleName();
	...
	public void onCreate(@Nullable Bundle savedInstanceState) {
		...
		addPreferencesFromResource(R.xml.themes_preferences);
	}
	...
	public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
		...
		switch (key) {
			case "preference_theme_classic":
				editor.putInt("theme", THEME_CLASSIC);
				break;
			case "preference_theme_light":
