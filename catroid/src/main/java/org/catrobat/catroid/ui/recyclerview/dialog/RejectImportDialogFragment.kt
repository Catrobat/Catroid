...
class RejectImportDialogFragment(
    ...
    constructor(conflicts: List<String>) : this(conflicts, CONFLICT_VARIABLE) {
        errorType = CONFLICT_VARIABLE
    }
    ...
    companion object {
        ...
        const val CONFLICT_SCREEN_ORIENTATION = -13
    }
    ...
    private fun setImportErrorText(
        ...
        when (errorType) {
            ...
            CONFLICT_SCREEN_ORIENTATION -> {
                importConflictReasonView.setText(R.string.import_conflicting_screen_orientation_reason)
                resolveView.setText(R.string.import_conflicting_screen_orientation_try_again)
                view.findViewById<TextView>(R.id.conflicting_variables)?.visibility = View.GONE
            }
        }
    }
