...
public abstract class SpriteListBaseAdapter extends CheckBoxListAdapter<Sprite> {

	public static final String TAG = SpriteListBaseAdapter.class.getSimpleName();

	public SpriteListBaseAdapter(Context context, int resource, List<Sprite> listItems) {
		super(context, resource, listItems);
	}

	public View getWrappedListItem(int position, View listItemView) {
