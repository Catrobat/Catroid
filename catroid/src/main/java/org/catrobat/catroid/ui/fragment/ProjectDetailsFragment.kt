...
val PROJECT_DETAIL_FRAGMENT_TAG = ProjectDetailsFragment::class.java.simpleName
...
class ProjectDetailsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        try {
            projectData = requireArguments().getSerializable(SELECTED_PROJECT_KEY) as ProjectData?
    ...
    private fun onExceptionThrown(e: Exception) {
        ...
        Log.e(PROJECT_DETAIL_FRAGMENT_TAG, Log.getStackTraceString(e))
