...
import org.catrobat.catroid.databinding.DialogPrivacyAwarenessGuideBinding

private const val SDK_VERSION = 24

class PrivacyAwarenessDialogFragment : DialogFragment() {
    private var _binding: DialogPrivacyAwarenessGuideBinding? = null
    private val binding get() = _binding!!

    override fun onCreateDialog(bundle: Bundle?): Dialog {
        _binding = DialogPrivacyAwarenessGuideBinding.inflate(LayoutInflater.from(activity))
        ...
        val builder = AlertDialog.Builder(requireActivity())
            .setTitle(R.string.dialog_privacy_awareness_title)
