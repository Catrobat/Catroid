...
@SuppressWarnings("MethodOverloading")
class SettingsFragment : PreferenceFragmentCompat() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        setupManageExtensionsPreference()
    ...
    private fun setupManageExtensionsPreference() {
    ...
    companion object {
        ...
        const val SETTINGS_MANAGE_EXTENSIONS = "setting_manage_extensions"
        const val LEGO_SENSORS_ARRAY_SIZE = 4
        const val DRONE_SENSOR_ARRAY_SIZE = 5

        val SETTINGS_FRAGMENT_TAG: String = SettingsFragment::class.java.simpleName
        ...
        fun isEmbroiderySharedPreferenceEnabled(context: Context): Boolean =
            getBooleanSharedPreference(false, SETTINGS_SHOW_EMBROIDERY_BRICKS, context)

        @JvmStatic
        fun isDroneSharedPreferenceEnabled(context: Context): Boolean =
            getBooleanSharedPreference(false, SETTINGS_SHOW_PARROT_AR_DRONE_BRICKS, context)

        @JvmStatic
        fun isJSSharedPreferenceEnabled(context: Context): Boolean =
            getBooleanSharedPreference(false, SETTINGS_SHOW_JUMPING_SUMO_BRICKS, context)

        @JvmStatic
        fun isMindstormsNXTSharedPreferenceEnabled(context: Context): Boolean =
            getBooleanSharedPreference(false, SETTINGS_MINDSTORMS_NXT_BRICKS_ENABLED, context)

        @JvmStatic
        fun isMindstormsEV3SharedPreferenceEnabled(context: Context): Boolean =
            getBooleanSharedPreference(false, SETTINGS_MINDSTORMS_EV3_BRICKS_ENABLED, context)

        @JvmStatic
        fun isPhiroSharedPreferenceEnabled(context: Context): Boolean =
            getBooleanSharedPreference(false, SETTINGS_SHOW_PHIRO_BRICKS, context)

        @JvmStatic
        fun isCastSharedPreferenceEnabled(context: Context): Boolean =
            getBooleanSharedPreference(false, SETTINGS_CAST_GLOBALLY_ENABLED, context)

        @JvmStatic
        fun isAIObjectDetectionSharedPreferenceEnabled(context: Context): Boolean =
            getBooleanSharedPreference(false, SETTINGS_SHOW_AI_OBJECT_DETECTION_SENSORS, context)

        @JvmStatic
        fun isAISpeechRecognitionSharedPreferenceEnabled(context: Context): Boolean =
            getBooleanSharedPreference(false, SETTINGS_SHOW_AI_SPEECH_RECOGNITION_SENSORS, context)

        @JvmStatic
        fun isAIPoseDetectionSharedPreferenceEnabled(context: Context): Boolean =
            getBooleanSharedPreference(false, SETTINGS_SHOW_AI_POSE_DETECTION_SENSORS, context)

        @JvmStatic
        fun isAIFaceDetectionSharedPreferenceEnabled(context: Context): Boolean =
            getBooleanSharedPreference(false, SETTINGS_SHOW_AI_FACE_DETECTION_SENSORS, context)

        @JvmStatic
        fun isAITextRecognitionSharedPreferenceEnabled(context: Context): Boolean =
            getBooleanSharedPreference(false, SETTINGS_SHOW_AI_TEXT_RECOGNITION_SENSORS, context)

        @JvmStatic
        fun isAISpeechSynthetizationSharedPreferenceEnabled(context: Context): Boolean =
            getBooleanSharedPreference(false, SETTINGS_SHOW_AI_SPEECH_SYNTHETIZATION_SENSORS, context)

        @JvmStatic
        fun isArduinoSharedPreferenceEnabled(context: Context): Boolean =
            getBooleanSharedPreference(false, SETTINGS_SHOW_ARDUINO_BRICKS, context)

        @JvmStatic
        fun isRaspiSharedPreferenceEnabled(context: Context): Boolean =
            getBooleanSharedPreference(false, SETTINGS_SHOW_RASPI_BRICKS, context)

        @JvmStatic
        fun isNfcSharedPreferenceEnabled(context: Context): Boolean =
            getBooleanSharedPreference(false, SETTINGS_SHOW_NFC_BRICKS, context)

        @JvmStatic
        fun isTestSharedPreferenceEnabled(context: Context): Boolean =
            getBooleanSharedPreference(BuildConfig.DEBUG, SETTINGS_TEST_BRICKS, context)

        @JvmStatic
        fun useCatBlocks(context: Context): Boolean =
            getBooleanSharedPreference(false, SETTINGS_USE_CATBLOCKS, context)
        ...
        @JvmStatic
        fun setJumpingSumoSharedPreferenceEnabled(context: Context, value: Boolean) {
            getSharedPreferences(context).edit {
        ...
        @JvmStatic
        fun setRaspiSharedPreferenceEnabled(context: Context, value: Boolean) {
            getSharedPreferences(context).edit {
        ...
        @JvmStatic
        fun getRaspiPort(context: Context) =
        ...
        @JvmStatic
        fun setLegoMindstormsNXTSensorMapping(context: Context, sensor: NXTSensor.Sensor, sensorSetting: String) {
            getSharedPreferences(context).edit {
        ...
        @JvmStatic
        fun setLegoMindstormsEV3SensorMapping(context: Context, sensor: EV3Sensor.Sensor, sensorSetting: String) {
            getSharedPreferences(context).edit {
                putString(sensorSetting, sensor.sensorCode)
            }
        }
        ...
        fun getDronePreferenceMapping(context: Context): Array<DroneConfigPreference.Preferences?> {
            ...
            val preferenceMapping = arrayOfNulls<DroneConfigPreference.Preferences>(DRONE_SENSOR_ARRAY_SIZE)
        ...
        @JvmStatic
        fun getDronePreferenceMapping(context: Context, preferenceSetting: String?): DroneConfigPreference.Preferences {
        ...
        private fun getBooleanSharedPreference(defaultValue: Boolean, settingsString: String, context: Context) =
