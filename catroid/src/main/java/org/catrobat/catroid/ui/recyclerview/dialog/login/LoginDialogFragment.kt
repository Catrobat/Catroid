...
class LoginDialogFragment : DialogFragment() {
    ...
    override fun onCreateDialog(bundle: Bundle?): Dialog {
        ...
        usernameEditText?.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable) {
                ...
                } else if (!s.toString().trim { it <= ' ' }.matches(Regex("^[a-zA-Z0-9-_.]*$"))) {
    ...
    private fun onLoginButtonClick() {
        ...
        connectionMonitor.observe(this, Observer { connectionActive ->
            if (connectionActive) {
                ...
                // TODO is reading out token really necessary here - it isn't used for logging in
    ...
    private fun handleLoginBtnStatus() {
        alertDialog?.getButton(AlertDialog.BUTTON_POSITIVE)?.let {
            it.isEnabled = !(usernameInputLayout?.isErrorEnabled ?: false || passwordInputLayout?.isErrorEnabled ?: false)
        }
    }
