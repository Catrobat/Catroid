...
public class CategoryBricksFactory {
	...
	protected List<Brick> setupLooksCategoryList(Context context, boolean isBackgroundSprite) {
		...
		looksBrickList.add(new ShowTextColorAndSizeBrick(BrickValues.X_POSITION, BrickValues.Y_POSITION,
				BrickValues.SET_SIZE_TO, BrickValues.SHOW_VARIABLE_COLOR));
	...
	protected List<Brick> setupDataCategoryList(Context context) {
		...
		dataBrickList.add(new ShowTextColorAndSizeBrick(BrickValues.X_POSITION, BrickValues.Y_POSITION,
				BrickValues.SET_SIZE_TO, BrickValues.SHOW_VARIABLE_COLOR));
