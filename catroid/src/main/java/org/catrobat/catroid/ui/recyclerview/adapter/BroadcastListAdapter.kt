...
class BroadcastListAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CheckableVH {
        val view = LayoutInflater.from(parent.context).inflate(viewType, parent, false)
        return CheckableVH(view)
    }

    override fun onBindViewHolder(holder: CheckableVH, position: Int) {
