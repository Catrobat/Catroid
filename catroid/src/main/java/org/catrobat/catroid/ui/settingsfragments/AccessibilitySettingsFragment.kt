...
class AccessibilitySettingsFragment : PreferenceFragmentCompat(), OnSharedPreferenceChangeListener {
    ...
    override fun onSharedPreferenceChanged(sharedPreference: SharedPreferences, p1: String?) {
    ...
    companion object {
        val ACCESSIBILITY_SETTINGS_FRAGMENT_TAG: String =
            AccessibilitySettingsFragment::class.java.simpleName
