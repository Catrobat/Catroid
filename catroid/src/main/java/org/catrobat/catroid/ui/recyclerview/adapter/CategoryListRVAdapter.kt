...
class CategoryListRVAdapter(private val items: List<CategoryListItem>) :
    ...
    data class CategoryListItem(var nameResId: Int, var text: String, @CategoryListItemType var type: Int) {
        @kotlin.jvm.JvmField
    ...
    override fun getItemViewType(position: Int): Int =
        if (items[position].header != null) R.layout.view_holder_category_list_item_with_headline else R.layout.view_holder_category_list_item
