...
class ActionPhysicsFactory : ActionFactory() {
    private val physicsWorld: PhysicsWorld
        get() = inject(ProjectManager::class.java).value.currentlyPlayingScene.physicsWorld
    ...
    override fun createGlideToAction(sprite: Sprite, sequence: SequenceAction, x: Formula?, y: Formula?, duration: Formula?): Action {
        ...
        val scope = Scope(inject(ProjectManager::class.java).value.currentProject, sprite, sequence)
