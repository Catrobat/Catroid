...
public class SetGravityBrick extends FormulaBrick {
	...
	public View getPrototypeView(Context context) {
		...
		textGravityX.setText(getStringForPrototypeView(BrickValues.PHYSIC_GRAVITY.x));
		TextView textGravityY = (TextView) prototypeView.findViewById(R.id.brick_set_gravity_edit_text_y);
		textGravityY.setText(getStringForPrototypeView(BrickValues.PHYSIC_GRAVITY.y));
