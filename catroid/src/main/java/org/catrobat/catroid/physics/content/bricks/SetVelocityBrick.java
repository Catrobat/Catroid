...
public class SetVelocityBrick extends FormulaBrick {
	...
	public View getPrototypeView(Context context) {
		...
		textVelocityX.setText(FormulaBrick.getStringFromFloatForBrickView(BrickValues.PHYSIC_VELOCITY.x));
		TextView textVelocityY = (TextView) prototypeView.findViewById(R.id.brick_set_velocity_edit_text_y);
		textVelocityY.setText(FormulaBrick.getStringFromFloatForBrickView(BrickValues.PHYSIC_VELOCITY.y));
