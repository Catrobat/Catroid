...
class SensorPhiroSideRightTest : SensorPhiroSideRight() {

    private lateinit var btSvervice: BluetoothDeviceService

    override fun getSensorValue(): Double = super.getPhiroSideRightValue(btSvervice)
    ...
    companion object {
        @Volatile
        private var instance: SensorPhiroSideRightTest? = null

        fun getInstance() =
            instance ?: synchronized(this) {
                instance ?: SensorPhiroSideRightTest().also { instance = it }
            }
    }
}
