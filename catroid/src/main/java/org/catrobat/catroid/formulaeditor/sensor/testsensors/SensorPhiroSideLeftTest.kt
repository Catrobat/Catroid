...
class SensorPhiroSideLeftTest : SensorPhiroSideLeft() {

    private lateinit var btSvervice: BluetoothDeviceService

    override fun getSensorValue(): Double = super.getPhiroSideLeftValue(btSvervice)
    ...
    companion object {
        @Volatile
        private var instance: SensorPhiroSideLeftTest? = null

        fun getInstance() =
            instance ?: synchronized(this) {
                instance ?: SensorPhiroSideLeftTest().also { instance = it }
            }
    }
}
