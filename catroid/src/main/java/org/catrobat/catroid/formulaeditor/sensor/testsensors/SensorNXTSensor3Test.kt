...
class SensorNXTSensor3Test : SensorNXTSensor3() {

    private lateinit var btSvervice: BluetoothDeviceService

    override fun getSensorValue(): Double = super.getNXTSensor3Value(btSvervice)
    ...
    companion object {
        @Volatile
        private var instance: SensorNXTSensor3Test? = null

        fun getInstance() =
            instance ?: synchronized(this) {
                instance ?: SensorNXTSensor3Test().also { instance = it }
            }
    }
}
