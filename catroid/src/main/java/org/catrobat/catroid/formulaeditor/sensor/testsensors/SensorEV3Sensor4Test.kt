...
class SensorEV3Sensor4Test : SensorEV3Sensor4() {

    private lateinit var btSvervice: BluetoothDeviceService

    override fun getSensorValue(): Double = super.getEV3Sensor4Value(btSvervice)
    ...
    companion object {
        @Volatile
        private var instance: SensorEV3Sensor4Test? = null

        fun getInstance() =
            instance ?: synchronized(this) {
                instance ?: SensorEV3Sensor4Test().also { instance = it }
            }
    }
}
