...
open class SensorObjectLayer : Sensor {

    override fun getSensorValue(): Double = getLookLayerIndex(
        SensorHandler.currentSprite, SensorHandler.currentSprite.look,
        SensorHandler.currentlyEditedScene.spriteList
    )

    protected fun getLookLayerIndex(sprite: Sprite?, look: Look, spriteList: List<Sprite?>): Double {
