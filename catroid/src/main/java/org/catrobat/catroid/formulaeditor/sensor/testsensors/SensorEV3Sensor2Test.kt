...
class SensorEV3Sensor2Test : SensorEV3Sensor2() {

    private lateinit var btSvervice: BluetoothDeviceService

    override fun getSensorValue(): Double = super.getEV3Sensor2Value(btSvervice)
    ...
    companion object {
        @Volatile
        private var instance: SensorEV3Sensor2Test? = null

        fun getInstance() =
            instance ?: synchronized(this) {
                instance ?: SensorEV3Sensor2Test().also { instance = it }
            }
    }
}
