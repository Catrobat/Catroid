...
class SensorPhiroFrontRightTest : SensorPhiroFrontRight() {

    private lateinit var btSvervice: BluetoothDeviceService

    override fun getSensorValue(): Double = super.getPhiroFrontRightValue(btSvervice)
    ...
    companion object {
        @Volatile
        private var instance: SensorPhiroFrontRightTest? = null

        fun getInstance() =
            instance ?: synchronized(this) {
                instance ?: SensorPhiroFrontRightTest().also { instance = it }
            }
    }
}
