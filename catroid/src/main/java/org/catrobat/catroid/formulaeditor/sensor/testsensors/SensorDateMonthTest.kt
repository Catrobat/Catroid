...
class SensorDateMonthTest: SensorDateMonth() {
    ...
    override fun getSensorValue(): Double = super.getMonth(testCalendar)
    ...
    companion object {
        @Volatile
        private var instance: SensorDateMonthTest? = null

        fun getInstance() =
            instance ?: synchronized(this) {
                instance ?: SensorDateMonthTest().also { instance = it }
            }
    }
}