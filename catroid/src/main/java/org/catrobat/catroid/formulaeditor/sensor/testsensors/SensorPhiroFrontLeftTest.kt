...
class SensorPhiroFrontLeftTest : SensorPhiroFrontLeft() {

    private lateinit var btSvervice: BluetoothDeviceService

    override fun getSensorValue(): Double = super.getPhiroFrontLeftValue(btSvervice)
    ...
    companion object {
        @Volatile
        private var instance: SensorPhiroFrontLeftTest? = null

        fun getInstance() =
            instance ?: synchronized(this) {
                instance ?: SensorPhiroFrontLeftTest().also { instance = it }
            }
    }
}
