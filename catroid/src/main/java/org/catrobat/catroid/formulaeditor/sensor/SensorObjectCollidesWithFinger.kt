...
class SensorObjectCollidesWithFinger : Sensor {

    override fun getSensorValue(): Double =
        calculateCollidesWithFinger(SensorHandler.currentSprite.look)

    private fun calculateCollidesWithFinger(look: Look): Double {
