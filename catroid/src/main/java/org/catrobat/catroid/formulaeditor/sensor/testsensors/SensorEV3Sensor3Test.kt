...
class SensorEV3Sensor3Test : SensorEV3Sensor3() {

    private lateinit var btSvervice: BluetoothDeviceService

    override fun getSensorValue(): Double = super.getEV3Sensor3Value(btSvervice)
    ...
    companion object {
        @Volatile
        private var instance: SensorEV3Sensor3Test? = null

        fun getInstance() =
            instance ?: synchronized(this) {
                instance ?: SensorEV3Sensor3Test().also { instance = it }
            }
    }
}
