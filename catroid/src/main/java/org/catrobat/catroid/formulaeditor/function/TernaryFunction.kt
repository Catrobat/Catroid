...
class TernaryFunction(private val action: TernaryFunctionAction) : FormulaFunction {
    override fun execute(vararg args: Double?): Any {
        val arg1 = args.getOrNull(0) ?: return 0.0
        val arg2 = args.getOrNull(1) ?: return 0.0
        val arg3 = args.getOrNull(2) ?: return 0.0
        return action.execute(arg1, arg2, arg3)
    }
}
