...
class SensorDateDayTest: SensorDateDay() {

    private var testCalendar: Calendar = Calendar.getInstance()

    override fun getSensorValue(): Double = super.getDay(testCalendar)
    ...
    companion object {
        @Volatile
        private var instance: SensorDateDayTest? = null

        fun getInstance() =
            instance ?: synchronized(this) {
                instance ?: SensorDateDayTest().also { instance = it }
            }
    }
}