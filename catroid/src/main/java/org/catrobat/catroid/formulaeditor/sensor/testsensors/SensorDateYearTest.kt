...
class SensorDateYearTest : SensorDateYear() {

    private var testCalendar: Calendar = Calendar.getInstance()

    override fun getSensorValue(): Double = super.getYear(testCalendar)
    ...
    companion object {
        @Volatile
        private var instance: SensorDateYearTest? = null

        fun getInstance() =
            instance ?: synchronized(this) {
                instance ?: SensorDateYearTest().also { instance = it }
            }
    }
}
