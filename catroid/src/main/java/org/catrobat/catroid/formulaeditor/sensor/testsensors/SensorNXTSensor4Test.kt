...
class SensorNXTSensor4Test : SensorNXTSensor4() {

    private lateinit var btSvervice: BluetoothDeviceService

    override fun getSensorValue(): Double = super.getNXTSensor4Value(btSvervice)
    ...
    companion object {
        @Volatile
        private var instance: SensorNXTSensor4Test? = null

        fun getInstance() =
            instance ?: synchronized(this) {
                instance ?: SensorNXTSensor4Test().also { instance = it }
            }
    }
}
