...
public final class SensorHandler implements SensorEventListener, LocationListener,
	...
	public void onLocationChanged(Location location) {
		...
		if (location.getProvider().equals(LocationManager.GPS_PROVIDER) || !isGpsConnected) {
			SensorLatitude.Companion.getInstance().setLatitude(location.getLatitude());
			SensorLongitude.Companion.getInstance().setLongitude(location.getLongitude());
			SensorLocationAccuracy.Companion.getInstance().setLocationAccuracy(location.getAccuracy());
