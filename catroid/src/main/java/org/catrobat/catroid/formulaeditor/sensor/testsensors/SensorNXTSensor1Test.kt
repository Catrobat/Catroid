...
class SensorNXTSensor1Test : SensorNXTSensor1() {

    private lateinit var btSvervice: BluetoothDeviceService

    override fun getSensorValue(): Double = super.getNXTSensor1Value(btSvervice)
    ...
    companion object {
        @Volatile
        private var instance: SensorNXTSensor1Test? = null

        fun getInstance() =
            instance ?: synchronized(this) {
                instance ?: SensorNXTSensor1Test().also { instance = it }
            }
    }
}
