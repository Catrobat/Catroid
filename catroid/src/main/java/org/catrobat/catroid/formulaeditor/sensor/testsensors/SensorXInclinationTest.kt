...
class SensorXInclinationTest : SensorXInclination() {

    override fun getSensorValue(): Double = super.calculateXInclination()
    ...
    companion object {
        @Volatile
        private var instance: SensorXInclinationTest? = null

        fun getInstance() =
            instance ?: synchronized(this) {
                instance ?: SensorXInclinationTest().also { instance = it }
            }
    }
}
