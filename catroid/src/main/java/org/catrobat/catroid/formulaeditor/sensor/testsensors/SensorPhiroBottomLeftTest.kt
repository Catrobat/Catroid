...
class SensorPhiroBottomLeftTest : SensorPhiroBottomLeft() {

    private lateinit var btSvervice: BluetoothDeviceService

    override fun getSensorValue(): Double = super.getPhiroBottomLeftValue(btSvervice)
    ...
    companion object {
        @Volatile
        private var instance: SensorPhiroBottomLeftTest? = null

        fun getInstance() =
            instance ?: synchronized(this) {
                instance ?: SensorPhiroBottomLeftTest().also { instance = it }
            }
    }
}
