...
class SensorEV3Sensor1Test : SensorEV3Sensor1() {

    private lateinit var btSvervice: BluetoothDeviceService

    override fun getSensorValue(): Double = super.getEV3Sensor1Value(btSvervice)
    ...
    companion object {
        @Volatile
        private var instance: SensorEV3Sensor1Test? = null

        fun getInstance() =
            instance ?: synchronized(this) {
                instance ?: SensorEV3Sensor1Test().also { instance = it }
            }
    }
}
