...
public enum Sensors {
	...
	LAST_FINGER_INDEX, FINGER_X, FINGER_Y, FINGER_TOUCHED, NUMBER_CURRENT_TOUCHES, OBJECT_LOOK_NUMBER(true), OBJECT_LOOK_NAME(true),
	...
	TEXT_BLOCK_SIZE, SPEECH_RECOGNITION_LANGUAGE, TEXT_TO_SPEECH_LANGUAGE;
