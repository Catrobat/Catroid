...
class BleQueueManager {
    private val operations: Queue<Operation> = LinkedList()
    var currentOperation: Operation? = null

    @Synchronized
    fun request(operation: Operation) {
    ...
    fun getNextOperation() {
        ...
        if (currentOperation?.hasAvailableCompletionCallback() == false) {
            operationCompleted()
        }
    }
