...
public final class StatusBarNotificationManager {
	...
	public NotificationData createProjectDownloadNotification(Context context, String programName) {
		return new NotificationData(R.drawable.ic_stat, programName,
				...
				context.getString(R.string.notification_title_open),
	...
	public void showOrUpdateNotification(Context context, NotificationData notificationData, int progressInPercent,
	...
	public void abortProgressNotificationWithMessage(Context context, NotificationData notificationData,
			@StringRes int changeDoneText) {
