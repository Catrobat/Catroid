...
public class SpriteListActivity extends BaseAppCompatActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getSupportActionBar().setTitle(getResources().getString(R.string.sprites));
	}

	public void handleAddButton(View view) {
		NewItemDialog dialog = new NewItemDialog(R.string.new_object, getFragment());
