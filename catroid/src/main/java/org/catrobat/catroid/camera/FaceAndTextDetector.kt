...
import org.catrobat.catroid.camera.VisualDetectionHandler.translateGoogleFaceToVisualDetectionFace
        ...
        imageProxy.image?.let { mediaImage ->
            ...
            faceDetectionClient.process(image)
                .addOnSuccessListener {
                    val faces = translateGoogleFaceToVisualDetectionFace(it)
