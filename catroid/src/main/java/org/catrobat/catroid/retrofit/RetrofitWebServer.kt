...
import org.catrobat.catroid.retrofit.models.MediaLibraryResponse
...
class CatroidWebServer private constructor() {
    companion object {
        ...
        @JvmStatic
        fun getWebService(baseUrl: String, additionalInterceptors: List<okhttp3.Interceptor> = emptyList()): WebService {
