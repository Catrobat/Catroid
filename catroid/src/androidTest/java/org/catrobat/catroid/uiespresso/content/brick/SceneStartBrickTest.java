...
public class SceneStartBrickTest {
	...
	public void testSceneStartBrick() {
		...
		onBrickAtPosition(brickPosition).checkShowsText(R.string.brick_scene_start);

		onBrickAtPosition(brickPosition).onSpinner(R.id.brick_scene_start_spinner)
				.checkShowsText(sceneName2);
	}
	...
	public void testDismissNewSceneDialog() {
		...
		assertEquals("Not in ScriptActivity", ScriptActivity.class,
				UiTestUtils.getCurrentActivity().getClass());
