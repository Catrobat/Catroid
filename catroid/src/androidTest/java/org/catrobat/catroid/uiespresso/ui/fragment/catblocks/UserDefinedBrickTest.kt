...
class UserDefinedBrickTest {
    ...
    companion object {
        ...
        private const val MAX_WEBVIEW_CHECK_ITERATIONSL: Int = 10
    }
    ...
    fun testUserDefinedBrickNestingAndRecursion() {
        ...
        checkIfIDSequenceExists(arrayOf("UserDefinedScript-0", "IfLogicBeginBrick-0",
        ...
        checkIfIDSequenceExists(arrayOf("UserDefinedScript-1", "IfLogicBeginBrick-1",
    ...
    private fun checkIfIDSequenceExists(ids: Array<String>) {
        val xpath = ids.map { id -> "//*[@id=\"$id\"]" }.joinToString("")
        ...
        while (true) {
            ...
            try {
                ...
                if (loadCounter >= MAX_WEBVIEW_CHECK_ITERATIONSL) {
                    throw throwable
                }
                Thread.sleep(100)
            }
    ...
    private fun createProject() {
        ...
        startScript.addBrick(userDefinedBrick1)
        startScript.addBrick(userDefinedBrick2)
