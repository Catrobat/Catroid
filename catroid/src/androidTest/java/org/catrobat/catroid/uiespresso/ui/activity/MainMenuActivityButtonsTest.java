...
public class MainMenuActivityButtonsTest {
    ...
    public void setUp() throws Exception{
        ...
        Espresso.registerIdlingResources(mainMenuIdlingResource);
    }
    ...
    public void buttonHelpWithConnectionCallsOpenHelpSite() {
        ...
        // asserttrue(...instanceof...) has no valueable errormessage
        assertEquals(WebViewActivity.class.getSimpleName(), UiTestUtils.getCurrentActivity().getClass().getSimpleName());
    ...
    public void tearDown() {
        Espresso.unregisterIdlingResources(mainMenuIdlingResource);
    }
}
