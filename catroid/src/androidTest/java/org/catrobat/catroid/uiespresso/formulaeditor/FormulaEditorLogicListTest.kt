...
class FormulaEditorLogicListTest(
    ...
    fun setUp() {
        val script = UiTestUtils.createProjectAndGetStartScript("FormulaEditorFunctionListTest")
        script.addBrick(ChangeSizeByNBrick(0.0))
        baseActivityTestRule.launchActivity()

        setShowBrickSettingsToTrue()
    }
    ...
    companion object {
        ...
        private val listOfFaceDetection = arrayListOf(
            arrayOf(
