...
public class UploadDefaultProgramFromProjectListFragmentTest {
	String token = Constants.NO_TOKEN;
	String projectName = "UploadDefaultProgramFromProjectListFragmentTest";
	...
	public BaseActivityInstrumentationRule<ProjectListActivity> baseActivityTestRule = new
			BaseActivityInstrumentationRule<>(ProjectListActivity.class);
	...
	public void testUploadDefaultProgram() {
		onView(withText(projectName)).perform(longClick());
