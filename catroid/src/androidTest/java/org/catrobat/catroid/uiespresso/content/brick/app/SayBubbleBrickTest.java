...
public class SayBubbleBrickTest {
	...
	public void setUp() throws Exception {
		BrickTestUtils.createProjectAndGetStartScript("sayBubbleBrickTest").addBrick(new SayBubbleBrick(sayString));
		brickPosition = 1;
	...
	@Test
	public void sayBubbleBrickTest() {
