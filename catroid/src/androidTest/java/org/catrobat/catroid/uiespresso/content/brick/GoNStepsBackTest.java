...
public class GoNStepsBackTest {
	...
	@Test
	public void goNStepsBackTest() {
		checkIfBrickAtPositionShowsString(0, R.string.brick_when_started);
		checkIfBrickAtPositionShowsString(brickPosition, R.string.brick_go_back);
		enterValueInFormulaTextFieldOnBrickAtPosition(10, R.id.brick_go_back_edit_text, brickPosition);
	}
}
