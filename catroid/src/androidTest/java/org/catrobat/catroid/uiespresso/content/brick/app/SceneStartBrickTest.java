...
public class SceneStartBrickTest {
	...
	private String projectName = "SceneStartBrickTest";
	private String sceneName1 = "Scene 1";
	private String sceneName2 = "Scene 2";
	...
	public void setUp() throws Exception {
		...
		project.addScene(new Scene(null, sceneName2, project));
		sprite.getScript(0).addBrick(new SceneStartBrick(sceneName1));
	...
	public void testSceneStartBrick() {
		...
		onBrickAtPosition(1)
				.checkShowsText(R.string.brick_scene_start);

		onBrickAtPosition(1)
				.onSpinner(R.id.brick_scene_start_spinner)
				.checkShowsText(sceneName1)
				.perform(click());
		onView(withText(sceneName1))
