...
public class AddItemToUserListTest {
	...
	public void testAddItemToUserListBrick() {
		...
		createNewVariableOnSpinnerInitial(R.id.add_item_to_userlist_spinner, brickPosition, toInsert);
		BrickTestUtils.enterValueInFormulaTextFieldOnBrickAtPosition(10, R.id.brick_add_item_to_userlist_edit_text, brickPosition);
	}
}
