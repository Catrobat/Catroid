...
public class SetXBrickTest {
	...
	public void testSetXBrick() {
		...
		checkIfBrickAtPositionShowsString(brickPosition, R.string.brick_set_x);
		enterValueInFormulaTextFieldOnBrickAtPosition(xToSet, R.id.brick_set_x_edit_text, brickPosition);
	}
}
