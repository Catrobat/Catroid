...
class TestUtilsBroadcastMessageBrick private constructor() {
    ...
    companion object {
        fun createNewBroadcastMessageOnBrick(
            ...
            onBrickAtPosition(brickPosition).editBroadcastMessage()
        ...
        fun editBroadcastMessageOnBrick(
            ...
            onView(allOf(withParent(withChild(withText(oldMessage))), withId(R.id.settings_button)))
                .perform(click())
