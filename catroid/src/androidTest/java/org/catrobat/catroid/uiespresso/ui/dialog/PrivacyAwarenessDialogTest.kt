...
class PrivacyAwarenessDialogTest {
    ...
    @Test
    fun privacyAwarenessDialogTest() {
        Espresso.openActionBarOverflowOrOptionsMenu(baseActivityTestRule.activity)

        Espresso.onView(ViewMatchers.withText(R.string.main_menu_privacy_awareness_guide))
            .perform(ViewActions.click())

        Espresso.onView(ViewMatchers.withText(R.string.dialog_privacy_awareness_title))
            .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))

        Espresso.onView(ViewMatchers.withText(R.string.dialog_privacy_awareness_info))
            .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
