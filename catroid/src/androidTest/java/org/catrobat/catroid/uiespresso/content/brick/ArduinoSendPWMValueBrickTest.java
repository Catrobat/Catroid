...
public class ArduinoSendPWMValueBrickTest {
	...
	public void createProject() {
		Script startScript = BrickTestUtils.createProjectAndGetStartScript("ArduinoSendPWMValueBrick");
		ArduinoSendPWMValueBrick arduinoSendPWMValueBrick = new ArduinoSendPWMValueBrick(3, 0);
		startScript.addBrick(arduinoSendPWMValueBrick);
	}
}
