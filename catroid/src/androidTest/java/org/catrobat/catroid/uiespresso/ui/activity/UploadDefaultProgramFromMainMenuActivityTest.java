...
public class UploadDefaultProgramFromMainMenuActivityTest {
	String token = Constants.NO_TOKEN;
	String projectName = "UploadDefaultProgramFromMainMenuActivityTest";
	...
	public void setUp() throws Exception {
		...
		hasUserAgreedToPrivacyPolicyBuffer = PreferenceManager.getDefaultSharedPreferences(InstrumentationRegistry.getTargetContext())
