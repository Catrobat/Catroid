...
class GroupSpriteFromLocalIntent {
    ...
    fun setUp() {
        ...
        resultData.putExtra(ImportLocalObjectActivity.REQUEST_SPRITE, arrayListOf("Clouds1"))
        resultData.putExtra(ImportLocalObjectActivity.REQUEST_GROUP_SPRITE, arrayListOf
            (testGroupSprite.name))
