...
public class ThinkForBubbleBrickTest {

	private int brickPositionOneSecond;
	private int brickPositionTwoSeconds;

	private String thinkString = "think something";
	...
	public void setUp() throws Exception {
		Script script = BrickTestUtils.createProjectAndGetStartScript("thinkBubbleBrickTest");
		script.addBrick(new ThinkForBubbleBrick(thinkString, durationOne));
	...
	@Test
	public void thinkForBubbleBrickTest() {
