...
public class RepeatBrickTest {
	...
	public void testAddBrick() {
		...
		onData(allOf(is(instanceOf(String.class)), is(UiTestUtils.getResourcesString(R.string.category_control))))
				...
				.perform(click());
		onData(is(instanceOf(RepeatBrick.class))).inAdapterView(BrickPrototypeListMatchers.isBrickPrototypeView())
				.perform(click());
		onBrickAtPosition(0).perform(click());

		onBrickAtPosition(0).checkShowsText(R.string.brick_when_started);
		onBrickAtPosition(1).checkShowsText(R.string.brick_repeat);
		onBrickAtPosition(2).checkShowsText(R.string.brick_repeat);
		onBrickAtPosition(3).checkShowsText(R.string.brick_loop_end);
		...
		RepeatBrick repeatBrick = (RepeatBrick) script.getBrickList().get(0);
		...
		repeatBrick = (RepeatBrick) script.getBrickList().get(1);
	...
	public void testCopyBrick() {
		...
		repeatBrick = (RepeatBrick) script.getBrickList().get(2);
