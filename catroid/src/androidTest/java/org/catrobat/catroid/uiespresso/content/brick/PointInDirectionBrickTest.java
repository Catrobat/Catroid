...
public class PointInDirectionBrickTest {
	...
	private static final double SET_DEGREE = 270;
	...
	public void createProject() {
		Script startScript = BrickTestUtils.createProjectAndGetStartScript("PointInDirectionBrick");
		PointInDirectionBrick pointInDirectionBrick = new PointInDirectionBrick(PointInDirectionBrick.Direction.RIGHT);
