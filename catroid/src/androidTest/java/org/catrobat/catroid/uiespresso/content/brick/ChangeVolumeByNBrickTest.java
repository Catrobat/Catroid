...
public class ChangeVolumeByNBrickTest {
	...
	public void changeVolumeByNBrick() {
		...
		checkIfBrickAtPositionShowsString(brickPosition, R.string.brick_change_volume_by);
		enterValueInFormulaTextFieldOnBrickAtPosition(changeValue, R.id.brick_change_volume_by_edit_text,
				brickPosition);
	}
}
