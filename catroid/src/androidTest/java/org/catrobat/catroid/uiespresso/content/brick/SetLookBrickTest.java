...
public class SetLookBrickTest {
	...
	public void testSetLookBrick() {
		...
		checkIfBrickAtPositionShowsString(brickPosition, R.string.brick_set_look);
	...
	public void testAddNewLook() throws Exception {
		...
		checkIfSpinnerOnBrickAtPositionShowsString(R.id.brick_set_look_spinner, brickPosition, paintroidFileName);
	...
	public void testSelectLookAndPlay() {
		...
		onView(withText(lookName2))
				.perform(click());
		checkIfSpinnerOnBrickAtPositionShowsString(R.id.brick_set_look_spinner, brickPosition, lookName2);
	...
	public void testDismissNewSceneDialog() {
		...
		checkIfSpinnerOnBrickAtPositionShowsString(R.id.brick_scene_start_spinner, brickPosition,
