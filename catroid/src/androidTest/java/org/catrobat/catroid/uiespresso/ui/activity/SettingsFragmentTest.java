...
import static org.catrobat.catroid.ui.settingsfragments.SettingsFragment.SETTINGS_SHOW_AI_FACE_NAME_DETECTION_SENSORS;
...
public class SettingsFragmentTest {
	...
	private List<String> allSettings = new ArrayList<>(Arrays.asList(SETTINGS_SHOW_ARDUINO_BRICKS,
			...
			SETTINGS_SHOW_AI_FACE_DETECTION_SENSORS,SETTINGS_SHOW_AI_FACE_NAME_DETECTION_SENSORS,
	...
	public void aiSettingsTest() {
		...
		checkPreference(R.string.preference_title_ai_face_name_detection,
