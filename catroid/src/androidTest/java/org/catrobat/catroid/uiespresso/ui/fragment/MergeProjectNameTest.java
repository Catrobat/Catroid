...
public class MergeProjectNameTest {
	...
	public void mergeProjectsValidNameTests() {
		...
		onView(withId(R.id.input_edit_text)).perform(typeText(validName), closeSoftKeyboard());
	...
	public void mergeProjectsInvalidSameNameTests() {
		...
		onView(withId(R.id.input_edit_text)).perform(typeText(inValidName), closeSoftKeyboard());

		onView(allOf(withId(android.R.id.button1), withText(R.string.ok)))
				.perform(click());

		onView(withId(R.id.input_edit_text)).check(matches(withText(R.string.name_already_exists)));
	}
	...
	public void mergeProjectsInvalidEmptyNameTests() {
		...
		onView(withId(R.id.input_edit_text)).check(matches(withText(R.string.name_consists_of_spaces_only)));
	}
