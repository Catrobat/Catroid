...
public class FormulaEditorObjectListTest {
	...
	String nameSprite2 = "testSprite2";
	...
	public static Iterable<Object[]> data() {
		return Arrays.asList(new Object[][] {
				...
				{R.string.formula_editor_function_collision, "touches_object"},
	...
	public void setUp() throws Exception {
		Project project = new Project(null, "FormulaEditorObjectTest");
		Sprite sprite = new Sprite("testSprite");
		Sprite sprite2 = new Sprite(nameSprite2);
	...
	public void testObjectListElements() {
		...
		if (editorFunction.equals(getResources().getString(R.string.formula_editor_function_collision))) {
