...
import static org.catrobat.catroid.R.id.brick_set_variable_label;
...
public class SetVariableBrickTest {
    ...
    @Test
    public void setVariableBrickTest() {

        checkIfBrickAtPositionShowsString(0, R.string.brick_when_started);
        checkIfBrickAtPositionShowsString(1, R.string.brick_set_variable);
        ...
        onView(withId(brick_set_variable_label)).check(matches(isDisplayed()));
        onScriptList().atPosition(1).onChildView(withId(R.id.set_variable_spinner)).onChildView(withText(userVariableName))
                .check(matches(isDisplayed()));
        onScriptList().atPosition(1).onChildView(withId(R.id.set_variable_spinner))
                .perform(click());
...
//                .check(matches(isDisplayed()));
        onScriptList().atPosition(1).onChildView(withId(R.id.brick_set_variable_edit_text)).perform(click());
    ...
    private void createProject() {
        ...
        SetVariableBrick setVariableBrick = new SetVariableBrick(10);
