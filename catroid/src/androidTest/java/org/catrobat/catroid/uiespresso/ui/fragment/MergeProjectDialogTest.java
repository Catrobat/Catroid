...
public class MergeProjectDialogTest {

	@Rule
	public BaseActivityInstrumentationRule<ProjectListActivity> baseActivityTestRule = new
			BaseActivityInstrumentationRule<>(ProjectListActivity.class, false, false);
	...
	@Test
	public void mergeProjectsDialogTests() {
		...
		onView(withText(R.string.new_merge_project_dialog_title)).inRoot(isDialog())
