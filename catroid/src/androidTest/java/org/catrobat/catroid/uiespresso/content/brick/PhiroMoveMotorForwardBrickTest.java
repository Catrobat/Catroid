...
public class PhiroMoveMotorForwardBrickTest {
	...
	@Before
	public void setUp() {
		PhiroMotorMoveForwardBrick phiroMotorMoveForwardBrick = new PhiroMotorMoveForwardBrick(PhiroMotorMoveForwardBrick.Motor
				.MOTOR_RIGHT, initialSpeed);
	...
	public void testPhiroMoveMotorForwardBrick() {
		...
		enterValueInFormulaTextFieldOnBrickAtPosition(setSpeed,
