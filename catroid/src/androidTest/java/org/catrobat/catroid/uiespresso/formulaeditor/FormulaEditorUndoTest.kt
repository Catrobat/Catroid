...
class FormulaEditorUndoTest {
    ...
    var baseActivityTestRule = FragmentActivityTestRule(
        SpriteActivity::class.java, SpriteActivity.EXTRA_FRAGMENT_POSITION, SpriteActivity.FRAGMENT_SCRIPTS
    )

    @After
    @Throws(Exception::class)
    fun tearDown() {
        TestUtils.deleteProjects(FormulaEditorUndoTest::class.java.name)
    }
    ...
    fun setUp() {
        brickPosition = 1
        val script = UiTestUtils.createProjectAndGetStartScript(FormulaEditorUndoTest::class.java.name)
        script.addBrick(PlaceAtBrick())
        userVariable = UserVariable(VARIABLE_NAME, VARIABLE_VALUE)
        ProjectManager.getInstance().currentProject.addUserVariable(userVariable)
    ...
    @Test
    fun testUndoFormulaChangesOnPressBack() {
    ...
    @Category(Cat.AppUi::class, Level.Smoke::class)
    @Test
    fun testUndoFormulaWithNoChanges() {
        onBrickAtPosition(brickPosition).checkShowsText(R.string.brick_place_at)
    ...
    @Category(Cat.AppUi::class, Level.Smoke::class)
    @Test
    fun testUndoFormulaWithRevertedChanges() {
        onBrickAtPosition(brickPosition).checkShowsText(R.string.brick_place_at)
        onView(withId(R.id.brick_place_at_edit_text_x))
            .perform(click())
        onView(withText(R.string.brick_context_dialog_formula_edit_brick))
    ...
    @Category(Cat.AppUi::class, Level.Smoke::class)
    @Test
    fun testUndoFormulaAddVariable() {
        onBrickAtPosition(brickPosition).checkShowsText(R.string.brick_place_at)
    ...
    @Category(Cat.AppUi::class, Level.Smoke::class)
    @Test
    fun testUndoFormulaDeleteVariable() {
        onBrickAtPosition(brickPosition).checkShowsText(R.string.brick_place_at)
    ...
    @Category(Cat.AppUi::class, Level.Smoke::class)
    @Test
    fun testUndoFormulaRenameVariable() {
        onBrickAtPosition(brickPosition).checkShowsText(R.string.brick_place_at)
    ...
    @Category(Cat.AppUi::class, Level.Smoke::class)
    @Test
    fun testUndoFormulaEditVariable() {
        onBrickAtPosition(brickPosition).checkShowsText(R.string.brick_place_at)
    ...
    @Category(Cat.AppUi::class, Level.Smoke::class)
    @Test
    fun testUndoFormulaWithSpinnerVariable() {
    ...
    @Category(Cat.AppUi::class, Level.Smoke::class)
    @Test
    fun testUndoFormulaWithColorPicker() {
        onBrickAtPosition(brickPosition).checkShowsText(R.string.brick_place_at)
    ...
    @Category(Cat.AppUi::class, Level.Smoke::class)
    @Test
    fun testUndoAfterActivityRecreationDoesNotCrash() {
        onBrickAtPosition(brickPosition).checkShowsText(R.string.brick_place_at)
    ...
    @Category(Cat.AppUi::class, Level.Smoke::class)
    @Test
    fun testUndoButtonHiddenAfterFormulaEditorUndo() {
        onBrickAtPosition(brickPosition).checkShowsText(R.string.brick_place_at)
        onView(withId(R.id.brick_place_at_edit_text_x))
            .perform(click())
        onView(withText(R.string.brick_context_dialog_formula_edit_brick))
    ...
    companion object {
        private const val VARIABLE_NAME = "TestVariable"
        private const val NEW_VARIABLE_NAME = "NewVariable"
        private const val VARIABLE_VALUE = 5
        private const val NEW_VARIABLE_VALUE = "10"
        private const val waitThreshold = 5000L
    }
}
