...
public class DroneSettingsActivityTest extends BaseActivityInstrumentationTestCase<MainMenuActivity> {
	...
	public void testDroneTermsOfUsePermanentAgree() {
		...
		assertFalse("Terms of servie should not be accepted", preferences.getBoolean(SettingsActivity.SETTINGS_PARROT_JUMPING_SUMO_CATROBAT_TERMS_OF_SERVICE_ACCEPTED_PERMANENTLY, true));
		...
		assertTrue("Terms of servie should be permanently accepted", preferences.getBoolean(SettingsActivity
