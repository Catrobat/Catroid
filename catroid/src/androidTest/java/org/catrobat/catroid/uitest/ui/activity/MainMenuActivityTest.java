...
public class MainMenuActivityTest extends BaseActivityInstrumentationTestCase<MainMenuActivity> {
	...
	public void testCreateNewProject() {
		...
		solo.goBack();
		assertFalse("New project dialog shouldn't showDialog up again!",
	...
	public void testLoadProject() {
		...
		assertTrue("MyProjectsActivity not shown", solo.waitForActivity(ProjectListActivity.class.getSimpleName()));
