...
class MergeTestUtils {
    ...
    fun assertSuccessfulSpriteMerge(
        ...
        assertTrue(mergedSprite.lookList.containsAll(sprite1.lookList))
        spritesToBeMerged.forEach {
            assertTrue(mergedSprite.lookList.containsAll(it.lookList))
        }
        assertTrue(mergedSprite.soundList.containsAll(sprite1.soundList))
        spritesToBeMerged.forEach {
            assertTrue(mergedSprite.soundList.containsAll(it.soundList))
        }
    ...
    fun assertSuccessfulSpriteImport(
        ...
        assertEquals(importedSprite.soundList, spriteToImport.soundList)
        assertEquals(importedSprite.lookList, spriteToImport.lookList)
