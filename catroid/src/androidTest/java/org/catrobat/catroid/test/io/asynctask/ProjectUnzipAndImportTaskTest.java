...
public class ProjectUnzipAndImportTaskTest {
	...
	public void testUnzipAndImportSingleProject() throws IOException {
		...
		assertEquals(AIR_FIGHT_0_5, new ProjectMetaDataParser(xmlFile).getProjectMetaData().getProjectName());
	}
	...
	public void testUnzipAndImportMultipleProjects() throws IOException {
		...
		assertEquals(FALLING_BALLS, new ProjectMetaDataParser(xmlFile).getProjectMetaData().getProjectName());
	}
	...
	public void testUnzipAndImportSameProjectTwice() throws IOException {
		...
		assertEquals(AIR_FIGHT_0_5_1, new ProjectMetaDataParser(xmlFile).getProjectMetaData().getProjectName());
	}
}
