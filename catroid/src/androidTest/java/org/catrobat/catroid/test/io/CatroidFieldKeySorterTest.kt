...
class CatroidFieldKeySorterTest {
    ...
    private class FieldKeySorterDecorator : FieldKeySorter {
        ...
        fun getFieldNames(fieldKeys: Map<FieldKey, Field>): Array<String> {
            ...
            for (fieldKeyEntry: Map.Entry<FieldKey, Field> in fieldKeys) {
                val fieldKey: FieldKey = fieldKeyEntry.key
    ...
    fun testGetFieldAlias() {
        val fieldKeyWithAlias = FieldKey(
            "a",
            SortAlphabeticallyWithAliases::class.java,
            0
        )
    ...
    private class SubClassWithNewMemberButWithoutAnnotation :
        BaseClassWithAnnotation() {
        private val c = 0
    }
}
