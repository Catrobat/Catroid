...
class CloudflareCertificateTest {

    private val client = CatrobatWebClient.client
    private val testUrl: String = "https://share.catrob.at/app/certificate/check"

    @Test
    fun testRouteSuccessful() {
