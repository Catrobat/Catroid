    ...
    companion object {
        ...
        fun parameters(): List<Array<Serializable?>> {
            return listOf(
                ...
                arrayOf(ForItemInUserListBrick::class.simpleName, ForItemInUserListBrick(), "For each value in list (value: (), list: ()) {\n}\n"),
                ...
                arrayOf(PlaySoundAndWaitBrick::class.simpleName, PlaySoundAndWaitBrick(), "Start sound and wait (sound: ());\n"),
                ...
                arrayOf(SetInstrumentBrick::class.simpleName, SetInstrumentBrick(), "Set (instrument: (piano));\n"),
                ...
                arrayOf(ShowTextColorSizeAlignmentBrick::class.simpleName, ShowTextColorSizeAlignmentBrick(), "Show (variable: (), x: (0), y: (0), size: (0), color: (#000000), alignment: (centered));\n"),
                ...
                arrayOf(SetParticleColorBrick::class.simpleName, SetParticleColorBrick(), "Set (particle color: (#000000));\n"),
                ...
                arrayOf(CameraBrick::class.simpleName, CameraBrick(), "Turn (camera: (on));\n"),
                arrayOf(ChooseCameraBrick::class.simpleName, ChooseCameraBrick(), "Use (camera: (front));\n"),
                ...
                arrayOf(SetPenColorBrick::class.simpleName, SetPenColorBrick(), "Set pen color (red: (0), green(0), blue(0));\n"),
                ...
                arrayOf(LegoEv3SetLedBrick::class.simpleName, LegoEv3SetLedBrick(), "Set EV3 LED (status: (green));\n"),
                ...
                arrayOf(PhiroRGBLightBrick::class.simpleName, PhiroRGBLightBrick(), "Set Phiro (light: (both), red: (0), green: (0), blue: (0));\n"),
                ...
                arrayOf(SetThreadColorBrick::class.simpleName, SetThreadColorBrick(), "Set (thread color: (#000000));\n"),
                ...
                arrayOf(AssertUserListsBrick::class.simpleName, AssertUserListsBrick(), "Assert lists (actual: (), expected: ());\n"),
