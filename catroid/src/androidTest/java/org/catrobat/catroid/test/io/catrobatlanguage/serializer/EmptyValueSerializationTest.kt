    ...
    companion object {
        ...
        fun parameters(): List<Array<Serializable?>> {
            return listOf(
                ...
                arrayOf(SetPhysicsObjectTypeBrick::class.simpleName, SetPhysicsObjectTypeBrick(), "Set (motion type: (not moving or bouncing under gravity (default)));\n"),
                ...
                arrayOf(ShowTextColorSizeAlignmentBrick::class.simpleName, ShowTextColorSizeAlignmentBrick(), "Show (variable: (), x: (0), y: (0), size: (0), color: (0), alignment: (centered));\n"),
