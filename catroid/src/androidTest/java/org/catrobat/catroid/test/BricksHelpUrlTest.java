...
public class BricksHelpUrlTest {
	...
	static {
		...
		brickToHelpUrlMapping.put("org.catrobat.catroid.content.bricks.GlideToActionBrick",
				"https://wiki.catrobat.org/bin/view/Documentation/BrickDocumentation/GlideToActionBrick");
