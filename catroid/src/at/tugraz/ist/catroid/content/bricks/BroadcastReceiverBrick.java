...
public class BroadcastReceiverBrick implements Brick {
	...
	private static final transient int brickBehavior = Brick.BACKGROUND_BRICK | Brick.NORMAL_BRICK;
	private static final transient int brickResources = NO_RESOURCES;
