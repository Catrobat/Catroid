...
public class CopyNotificationManager {

	private Integer id;
	private HashMap<Integer, NotificationData> notificationDataMap;
	public static final CopyNotificationManager INSTANCE = new CopyNotificationManager();

	private CopyNotificationManager() {
		this.id = 0;
		notificationDataMap = new HashMap<Integer, NotificationData>();
	}

	public static CopyNotificationManager getInstance() {
		return INSTANCE;
	}
	...
	public Integer createNotification(String name, Activity activity, Class<?> notificationClass) {
		...
		if (notificationClass == CopyProjectTask.class) {
			notificationTitle = "copying project";
		}
