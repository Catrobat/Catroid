...
public class ObjectStreamClass implements Serializable {
	...
	private static final int CLASS_MODIFIERS_MASK = Modifier.PUBLIC | Modifier.FINAL | Modifier.INTERFACE
			| Modifier.ABSTRACT;

	private static final int FIELD_MODIFIERS_MASK = Modifier.PUBLIC | Modifier.PRIVATE | Modifier.PROTECTED
			| Modifier.STATIC | Modifier.FINAL | Modifier.VOLATILE | Modifier.TRANSIENT;

	private static final int METHOD_MODIFIERS_MASK = Modifier.PUBLIC | Modifier.PRIVATE | Modifier.PROTECTED
	...
	/**
	 * Return the java.lang.reflect.Field {@code serialPersistentFields} if class {@code cl} implements it. Return null
	 * otherwise.
	 * 
	 * @param cl
	 ...
	 * 
	 * @return the class in the local VM that this descriptor represents; {@code null} if there is no corresponding
	 *         class.
	 */
	 ...
	 * @return {@code true} if the two classes belong to the same package, {@code false} otherwise.
	 */
	 ...
	 * @param cl
	 *            a java.lang.Class which to test
	 * @return {@code true} if the class has <clinit> {@code false} if the class does not have <clinit>
	 */
	 ...
	 * @param cl
	 *            a java.lang.Class which to test
	 * @return {@code true} if instances of the class are Externalizable {@code false} if instances of the class are not
	 *         Externalizable
	 * 
	 * @see Object#hashCode
	 */
	 ...
	 * 
	 * @param typecode
	 *            a char describing the typecode
	 * @return {@code true} if the typecode represents a primitive type {@code false} if the typecode represents an
	 ...
	 * @param cl
	 *            a java.lang.Class which to test
	 * @return {@code true} if instances of the class are Serializable {@code false} if instances of the class are not
	 *         Serializable
	 * 
	 * @see Object#hashCode
	 */
	...
	/**
	 * Return the descriptor (ObjectStreamClass) corresponding to the class {@code cl}. Returns an ObjectStreamClass
	 * even if instances of the
	 ...
	 */
	private static SoftReference<ThreadLocal<WeakHashMap<Class<?>, ObjectStreamClass>>> storage = new SoftReference<ThreadLocal<WeakHashMap<Class<?>, ObjectStreamClass>>>(
			null);
	...
	/**
	 * Return the java.lang.reflect.Method if class <code>cl</code> implements <code>methodName</code> . Return null
	 * otherwise.
	 * 
	 * @param cl
	 *            a java.lang.Class which to test
