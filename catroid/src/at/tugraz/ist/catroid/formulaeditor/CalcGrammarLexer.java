...
public class CalcGrammarLexer extends Lexer {
	...
	public void mTokens() throws RecognitionException {
		// src/CalcGrammar.g:1:8: ( T__22 | T__23 | T__24 | WS | COMMENT | CONSTANT | RELOP | MULOP | PLUS | MINUS | OR | NOT | LAND | NUMBER | ID )
		int alt8 = 15;
		switch (input.LA(1)) {
			case '(': {
				alt8 = 1;
