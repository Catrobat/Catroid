...
public class InstalledAppAdapter extends ArrayAdapter<InstalledApplicationInfo> {
	private ArrayList<InstalledApplicationInfo> applicationInfoItems;
	private Activity activity;

	public InstalledAppAdapter(Activity activity, int textViewResourceId, ArrayList<InstalledApplicationInfo> objects) {
