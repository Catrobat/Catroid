...
public class ToolBoxAdapter extends BaseAdapter {
	...
	public ToolBoxAdapter(Context context, ArrayList<HashMap<String, String>> data) {
		mCtx = context;
		mContent = data;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		case (BrickDefine.SET_BACKGROUND): {
			...
			RelativeLayout setBackgroundView = (RelativeLayout) inflater.inflate(R.layout.toolbox_brick_set_background, null);
		...
		case (BrickDefine.PLAY_SOUND): {
			...
			RelativeLayout playSoundView = (RelativeLayout) inflater.inflate(R.layout.toolbox_brick_play_sound, null);
		...
		case (BrickDefine.COME_TO_FRONT): {
			if (mViewContainer.containsKey(type))
				return mViewContainer.get(type);
			RelativeLayout view = (RelativeLayout) inflater.inflate(R.layout.toolbox_brick_come_to_front, null);
			mViewContainer.put(type, view);
			return view;
		}
