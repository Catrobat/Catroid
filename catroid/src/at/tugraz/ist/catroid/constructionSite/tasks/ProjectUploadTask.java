...
public class ProjectUploadTask extends AsyncTask<Void, Void, Boolean> {
	...
	protected void onPostExecute(Boolean result) {
		...
		if(!result) {
			Toast.makeText(mContext, R.string.error_project_upload, Toast.LENGTH_SHORT);
			return;
		}
		
		Toast.makeText(mContext, R.string.success_project_upload, Toast.LENGTH_SHORT);
