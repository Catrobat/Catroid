...
public final class JavaApiConverter {
  ...
  /**
   * Creates an OkHttp {@link com.squareup.okhttp.Response} using the supplied {@link java.net.URI} and {@link java.net.URLConnection}
  ...
  /**
   * Creates an OkHttp {@link com.squareup.okhttp.Response} using the supplied {@link com.squareup.okhttp.Request} and {@link java.net.CacheResponse}
   * to supply the data.
   */
  ...
  /**
   * Creates an OkHttp {@link com.squareup.okhttp.Request} from the supplied information.
   *
   ...
   * gathered from the supplied {@link com.squareup.okhttp.Response}.
   */
   ...
   * {@link com.squareup.okhttp.Response}.
   */
  ...
  /**
   * Extracts OkHttp headers from the supplied {@link java.util.Map}. Only real headers are
