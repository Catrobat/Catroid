 ...
 * {@link com.squareup.okhttp.internal.spdy.Settings#getMaxFrameSize frame size setting} to the peer. Hence, we
...
public final class Http20Draft14 implements Variant {
   ...
   * com.squareup.okhttp.internal.spdy.HpackDraft09.Reader#readHeaders()}.
   */
  ...
  static final class FrameLogger {
    ...
    static String formatHeader(boolean inbound, int streamId, int length, byte type, byte flags) {
      ...
      return format(Locale.getDefault(), "%s 0x%08x %5d %-13s %s", inbound ? "<<" : ">>", streamId, length,
