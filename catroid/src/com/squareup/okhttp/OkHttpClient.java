...
public class OkHttpClient implements Cloneable {
   ...
   *
   * <p>If unset, the {@link javax.net.SocketFactory#getDefault() system-wide default}
   ...
   *
   * <p>If unset, the {@link com.squareup.okhttp.ConnectionPool#getDefault() system-wide
   ...
   *
   * <p>{@link com.squareup.okhttp.Protocol#HTTP_1_0} is not supported in this set. Requests are
   * initiated with {@code HTTP/1.1} only. If the server responds with {@code
   * HTTP/1.0}, that will be exposed by {@link com.squareup.okhttp.Response#protocol()}.
   *
   * @param protocols the protocols to use, in order of preference. The list
   *     must contain {@link com.squareup.okhttp.Protocol#HTTP_1_1}. It must not contain null or
   *     {@link com.squareup.okhttp.Protocol#HTTP_1_0}.
   */
   ...
   * accessible to HTTP clients as {@link javax.net.ssl.SSLSocketFactory#getDefault()}. If we
