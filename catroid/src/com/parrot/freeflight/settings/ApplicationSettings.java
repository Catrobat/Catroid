...
public class ApplicationSettings {
	...
	public enum EAppSettingProperty {
		FIRST_LAUNCH_PROP("first_launch"), LEFT_HANDED_PROP("left_handed"), FORCE_COMBINED_CTRL_PROP(
				"force_combined_control"), CONTROL_MODE_PROP("control_mode"), INTERFACE_OPACITY_PROP(
				"interface_opacity"), MAGNETO_ENABLED_PROP("magneto_enabled"), LOOPING_ENABLED_PROP("looping_enabled"), ASK_FOR_GPS(
				"ask_for_gps");
	 ...
	 * 
	 * @param controlMode
	 *            EASY_MODE, ACCELERO_MODE or ACE_MODE>
	 *            <p>
	 ...
	 *            <li>ACE_MODE stands for single joystick that uses G sensor in order to control roll and pitch, and
	 *            thumb controls the gaz and yaw.</li>
	 */
	 ...
	 *            one of the Build.VERSION_CODES value.
	 ...
	 * 
	 * @param enabled
	 *            - if set to true - AR.Drone will use compass to fly relative to the user.
	 */
