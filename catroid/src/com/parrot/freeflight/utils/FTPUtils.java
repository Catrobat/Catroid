...
public class FTPUtils {
	 ...
	 *            - port
	 * @param local
	 *            - local file name in assets folder
	 * @param remote
	 *            - remote file name
	 * @param listener
	 *            - instance of ProgressListener. May be null.
	 * @return returns true if success or false if error occurred.
	 */
	public static boolean uploadFile(Context context, String host, int port, String local, String remote,
