...
import static org.catrobat.catroid.ui.settingsfragments.SettingsFragment.SETTINGS_TEST_BRICKS;
...
public class BrickAddCategoryTest {
	...
	private final List<String> allPeripheralCategories = new ArrayList<>(Arrays.asList(SETTINGS_MINDSTORMS_NXT_BRICKS_CHECKBOX_PREFERENCE,
			...
			SETTINGS_SHOW_EMBROIDERY_BRICKS_CHECKBOX_PREFERENCE, SETTINGS_SHOW_JUMPING_SUMO_BRICKS, SETTINGS_TEST_BRICKS));
