...
public class FormulaTest {
	...
	public void singleStringNumberTest() {
		...
		singleNumberTestHelper(stringFormulaElement, "1000");
	}
	...
	private void singleNumberTestHelper(FormulaElement formulaElement, String expectedResult) {
		Formula formula = new Formula(formulaElement);
		StringProvider stringProvider = mock(StringProvider.class);
		String computeDialogResult = formula.getUserFriendlyString(stringProvider, null);
		assertEquals(expectedResult, computeDialogResult);
	}
}
