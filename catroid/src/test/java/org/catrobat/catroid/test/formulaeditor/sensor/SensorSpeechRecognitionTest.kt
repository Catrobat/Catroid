...
class SensorSpeechRecognitionTest {

    @Test
    fun userLanguageTest() {
        val expectedValue = "test language"
        SensorSpeechRecognition.getInstance().updateSensorValue(expectedValue)
        compareToSensor(expectedValue, Sensors.SPEECH_RECOGNITION_LANGUAGE)
    }
