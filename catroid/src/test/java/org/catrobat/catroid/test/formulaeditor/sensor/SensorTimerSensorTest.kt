...
import org.catrobat.catroid.formulaeditor.sensor.testsensors.SensorTimerTest
...
class SensorTimerSensorTest {
    ...
    fun setup() {
        ...
        SensorTimerTest.getInstance().timerReferenceValue = 1000.0
        SensorTimerTest.getInstance().refValueTest = 11_000
    }

    @Test
    fun calendarSensorsTest() {
        compareToSensor(10, SensorTimerTest.getInstance())
    }
