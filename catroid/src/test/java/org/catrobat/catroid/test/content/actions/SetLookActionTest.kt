...
class SetLookActionTest {
    ...
    fun testSetLook() {
        ...
        sprite.actionFactory.createSetLookAction(sprite, lookData2).act(1f)
        assertEquals(lookData2, sprite.look.lookData)
    }

    @Test
    fun testLookNull() {
        sprite.actionFactory.createSetLookAction(sprite, null).act(1f)
        assertEquals(lookData1, sprite.look.lookData)
    }

    @Test
    fun testSpriteNull() {
        sprite.actionFactory.createSetLookAction(null, lookData2).act(1f)
        assertEquals(lookData1, sprite.look.lookData)
    }
}
