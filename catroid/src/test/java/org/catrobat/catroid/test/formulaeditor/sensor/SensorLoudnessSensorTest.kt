...
class SensorLoudnessSensorTest {

    @Test
    fun loudnessSensorTest() {
        val expectedValue = 47
        SensorLoudnessSensor.getInstance().updateSensorValue(expectedValue.toDouble())
        compareToSensor(expectedValue, Sensors.LOUDNESS)
    }
