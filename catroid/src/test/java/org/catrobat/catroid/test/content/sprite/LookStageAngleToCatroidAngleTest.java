...
public class LookStageAngleToCatroidAngleTest {
	...
	public void testStageAngleToCatroidAngle() {
		...
		assertEquals(expectedNegativeAngle, look.convertStageAngleToCatroidAngle(negativeInputAngle));
		assertEquals(expectedNegativeAngle, look.convertStageAngleToCatroidAngle(negativeInputAngle - 360.0f));
	}
}
