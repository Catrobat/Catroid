...
public class InsertItemintoUserListActionTest {
	...
	public void testInsertNumericalValueToUserList() {
		actionFactory.createInsertItemIntoUserListAction(testSprite, new SequenceAction(),
				new Formula(1), new Formula(DOUBLE_VALUE_ITEM_TO_ADD), userList).act(1f);
	...
	public void testInsertNumericalValueToUserListAtLastPosition() {
		actionFactory.createInsertItemIntoUserListAction(testSprite, new SequenceAction(),
				new Formula(3), new Formula(DOUBLE_VALUE_ITEM_TO_ADD), userList).act(1f);
	...
	public void testInsertItemWithInvalidUserList() {
		actionFactory.createInsertItemIntoUserListAction(testSprite, new SequenceAction(),
				new Formula(1), new Formula(DOUBLE_VALUE_ITEM_TO_ADD), null).act(1f);
