...
class SetPenColorActionTest {
    ...
    @Test
    fun testNormalBehaviorColorChange() {
    ...
    private fun compareColor(color1: Float, color2: Float): Boolean {
        if (color1 == color2) { return true }
        return false
    }

    private fun comparePenColors(color1: PenColor, color2: PenColor): Boolean {
        if (!compareColor(color1.a, color2.a)) { return false }
        if (compareColor(color1.r, color2.r) && compareColor
                (color1.g, color2.g) && compareColor(color1.b, color2.b)) { return true }
        return false
    }
