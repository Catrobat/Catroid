...
public class BrickSpinnerTest {
	...
	public static Collection<Object[]> data() {
		return asList(new Object[][] {
				{SceneTransitionBrick.class.getSimpleName(), new SceneTransitionBrick(""), R.id.brick_scene_transition_spinner, "new…", asList("new…", "Scene 2")},
				{SceneStartBrick.class.getSimpleName(), new SceneStartBrick(""), R.id.brick_scene_start_spinner, "new…", asList("new…", "Scene (1)", "Scene 2")},
				...
				{PointToBrick.class.getSimpleName(), new PointToBrick(), R.id.brick_point_to_spinner, "new…", asList("new…", "otherTestSprite")},
				...
				{PlaySoundBrick.class.getSimpleName(), new PlaySoundBrick(), R.id.brick_play_sound_spinner, "new…", asList("new…", "someSound")},
				{PlaySoundAndWaitBrick.class.getSimpleName(), new PlaySoundAndWaitBrick(), R.id.brick_play_sound_spinner, "new…", asList("new…", "someSound")},
				{AskSpeechBrick.class.getSimpleName(), new AskSpeechBrick(), R.id.brick_ask_speech_spinner, "new…", asList("new…", "someVariable")},
				{SetLookBrick.class.getSimpleName(), new SetLookBrick(), R.id.brick_set_look_spinner, "new…", asList("new…", "someLook")},
				{SetBackgroundBrick.class.getSimpleName(), new SetBackgroundBrick(), R.id.brick_set_background_spinner, "new…", asList("new…", "someBackground")},
				{SetBackgroundAndWaitBrick.class.getSimpleName(), new SetBackgroundAndWaitBrick(), R.id.brick_set_background_spinner, "new…", asList("new…", "someBackground")},
				{SetVariableBrick.class.getSimpleName(), new SetVariableBrick(), R.id.set_variable_spinner, "new…", asList("new…", "someVariable")},
				{ChangeVariableBrick.class.getSimpleName(), new ChangeVariableBrick(), R.id.change_variable_spinner, "new…", asList("new…", "someVariable")},
				{ShowTextBrick.class.getSimpleName(), new ShowTextBrick(), R.id.show_variable_spinner, "new…", asList("new…", "someVariable")},
				{ShowTextColorSizeAlignmentBrick.class.getSimpleName() + " variable", new ShowTextColorSizeAlignmentBrick(), R.id.show_variable_color_size_spinner, "new…", asList("new…", "someVariable")},
				...
				{HideTextBrick.class.getSimpleName(), new HideTextBrick(), R.id.hide_variable_spinner, "new…", asList("new…", "someVariable")},
				{AddItemToUserListBrick.class.getSimpleName(), new AddItemToUserListBrick(), R.id.add_item_to_userlist_spinner, "new…", asList("new…", "someList")},
				{DeleteItemOfUserListBrick.class.getSimpleName(), new DeleteItemOfUserListBrick(), R.id.delete_item_of_userlist_spinner, "new…", asList("new…", "someList")},
				{InsertItemIntoUserListBrick.class.getSimpleName(), new InsertItemIntoUserListBrick(), R.id.insert_item_into_userlist_spinner, "new…", asList("new…", "someList")},
				{ReplaceItemInUserListBrick.class.getSimpleName(), new ReplaceItemInUserListBrick(), R.id.replace_item_in_userlist_spinner, "new…", asList("new…", "someList")},
				{BroadcastReceiverBrick.class.getSimpleName(), new BroadcastReceiverBrick(new BroadcastScript("initialMessage")), R.id.brick_broadcast_spinner, "new…", asList("new…", "edit…", "initialMessage")},
				{BroadcastBrick.class.getSimpleName(), new BroadcastBrick("initialMessage"), R.id.brick_broadcast_spinner, "new…", asList("new…", "edit…", "initialMessage")},
				{BroadcastWaitBrick.class.getSimpleName(), new BroadcastWaitBrick("initialMessage"), R.id.brick_broadcast_spinner, "new…", asList("new…", "edit…", "initialMessage")},
				{WhenBackgroundChangesBrick.class.getSimpleName(), new WhenBackgroundChangesBrick(), R.id.brick_when_background_spinner, "new…", asList("new…", "someBackground")},
				...
				{WhenNfcBrick.class.getSimpleName(), new WhenNfcBrick(), R.id.brick_when_nfc_spinner, "Edit list of NFC tags", asList("Edit list of NFC tags", "all")},
