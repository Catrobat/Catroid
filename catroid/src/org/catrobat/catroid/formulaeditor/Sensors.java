...
public enum Sensors { X_ACCELERATION, Y_ACCELERATION, Z_ACCELERATION, COMPASS_DIRECTION, X_INCLINATION,
	...
	OBJECT_X(true), OBJECT_Y(true), OBJECT_TRANSPARENCY(true), OBJECT_BRIGHTNESS(true), OBJECT_COLOR(true), OBJECT_SIZE(true), OBJECT_ROTATION(true), OBJECT_LAYER(true), NXT_SENSOR_1,
	NXT_SENSOR_2, NXT_SENSOR_3, NXT_SENSOR_4, PHIRO_FRONT_LEFT, PHIRO_FRONT_RIGHT, PHIRO_SIDE_LEFT, PHIRO_SIDE_RIGHT,
	PHIRO_BOTTOM_LEFT, PHIRO_BOTTOM_RIGHT, ARDUINOANALOG, ARDUINODIGITAL;
public enum Sensors {
