...
public enum Sensors {
	X_ACCELERATION, Y_ACCELERATION, Z_ACCELERATION, COMPASS_DIRECTION, X_INCLINATION, Y_INCLINATION, LOUDNESS, FACE_DETECTED, FACE_SIZE, FACE_X_POSITION, FACE_Y_POSITION, OBJECT_X(
			...
			true), OBJECT_LAYER(true), NXT_SENSOR_1, NXT_SENSOR_2, NXT_SENSOR_3, NXT_SENSOR_4, PHIRO_PRO_FRONT_LEFT,
			PHIRO_PRO_FRONT_RIGHT, PHIRO_PRO_SIDE_LEFT, PHIRO_PRO_SIDE_RIGHT, PHIRO_PRO_BOTTOM_LEFT, PHIRO_PRO_BOTTOM_RIGHT;
