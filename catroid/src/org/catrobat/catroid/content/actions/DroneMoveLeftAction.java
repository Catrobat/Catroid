...
public class DroneMoveLeftAction extends TemporalAction {

	private static final String TAG = DroneMoveLeftAction.class.getSimpleName();
	...
	protected void end() {
		...
		DroneServiceWrapper.getInstance().getDroneService().moveLeft(0);
	}
