...
public class MoveNStepsAction extends TemporalAction {
	...
	protected void update(float percent) {
		...
		int newXPosition = (int) Math.round(sprite.look.getXInUserInterfaceDimensionUnit() + stepsValue * Math.cos(radians));
		int newYPosition = (int) Math.round(sprite.look.getYInUserInterfaceDimensionUnit() + stepsValue * Math.sin(radians));
