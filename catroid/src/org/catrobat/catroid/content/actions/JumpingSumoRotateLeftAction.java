...
public class JumpingSumoRotateLeftAction extends TemporalAction {
	...
	//private JumpingSumoRotateBrick.AngularDimension angularEnum;
	...
	//	angularEnum = dim;
	//	Log.i(TAG, "Angel: what it is:" + angularEnum);
	//}
	...
	protected void move() {
		if (deviceController != null) {
			...
			float radian = (float) (newDegree * Math.PI / 180);
			Log.d(TAG, "rotate with " + radian);
			deviceController.getFeatureJumpingSumo().sendPilotingAddCapOffset(-radian);
