...
import org.catrobat.catroid.content.bricks.WhenFaceDetectedBrick;

public class WhenFaceDetectedScript extends Script {

	private static final long serialVersionUID = 1L;

	public WhenFaceDetectedScript(Sprite sprite) {
		super(sprite);
	}

	public WhenFaceDetectedScript(Sprite sprite, WhenFaceDetectedBrick brick) {
		this(sprite);
		this.brick = brick;
	}
	...
	public ScriptBrick getScriptBrick() {
		if (brick == null) {
			brick = new WhenFaceDetectedBrick(object, this);
		}
	...
	public Script copyScriptForSprite(Sprite copySprite) {
		Script cloneScript = new WhenFaceDetectedScript(copySprite);
