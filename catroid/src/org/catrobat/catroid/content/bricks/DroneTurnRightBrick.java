...
public class DroneTurnRightBrick extends BrickBaseType implements OnClickListener, FormulaBrick {
	private static final long serialVersionUID = 1L;
	private Formula timeToFlyInSeconds;
	private Formula powerInPercent;
	private transient View prototypeView;

	public DroneTurnRightBrick(Sprite sprite, int timeInMillisecondsValue, int powerInPercent) {
		this.sprite = sprite;
		this.timeToFlyInSeconds = new Formula(timeInMillisecondsValue / 1000.0);
		this.powerInPercent = new Formula(powerInPercent);
	}

	public DroneTurnRightBrick(Sprite sprite, Formula time, Formula powerInPercent) {
		this.sprite = sprite;
	...
	public Brick copyBrickForSprite(Sprite sprite, Script script) {
		DroneTurnRightBrick copyBrick = (DroneTurnRightBrick) clone();
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		TextView textTime = (TextView) view.findViewById(R.id.brick_drone_turn_right_prototype_text_view_second);
		TextView editTime = (TextView) view.findViewById(R.id.brick_drone_turn_right_edit_text_second);
		timeToFlyInSeconds.setTextFieldId(R.id.brick_drone_turn_right_edit_text_second);
		timeToFlyInSeconds.refreshTextField(view);

		TextView times = (TextView) view.findViewById(R.id.brick_drone_turn_right_text_view_second);
		...
		TextView textPower = (TextView) view.findViewById(R.id.brick_drone_turn_right_prototype_text_view_power);
		TextView editPower = (TextView) view.findViewById(R.id.brick_drone_turn_right_edit_text_power);
		powerInPercent.setTextFieldId(R.id.brick_drone_turn_right_edit_text_power);
		powerInPercent.refreshTextField(view);

		//TextView power = (TextView) view.findViewById(R.id.brick_drone_turn_right_text_view_power);
	...
	public View getPrototypeView(Context context) {
		prototypeView = View.inflate(context, R.layout.brick_drone_turn_right, null);
		TextView textTime = (TextView) prototypeView
				.findViewById(R.id.brick_drone_turn_right_prototype_text_view_second);
		textTime.setText(String.valueOf(timeToFlyInSeconds.interpretInteger(sprite)));
		TextView times = (TextView) prototypeView.findViewById(R.id.brick_drone_turn_right_text_view_second);
		times.setText(context.getResources().getQuantityString(R.plurals.second_plural,
				Utils.convertDoubleToPluralInteger(timeToFlyInSeconds.interpretDouble(sprite))));

		TextView textPower = (TextView) prototypeView
				.findViewById(R.id.brick_drone_turn_right_prototype_text_view_power);
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			View layout = view.findViewById(R.id.brick_drone_turn_right_layout);
			Drawable background = layout.getBackground();
			background.setAlpha(alphaValue);

			TextView textTimeLabel = (TextView) view.findViewById(R.id.brick_drone_turn_right_label);
			TextView textPercent = (TextView) view.findViewById(R.id.brick_set_size_to_percent);

			TextView textTimeSeconds = (TextView) view.findViewById(R.id.brick_drone_turn_right_text_view_second);
			TextView editTime = (TextView) view.findViewById(R.id.brick_drone_turn_right_edit_text_second);

			TextView textPower = (TextView) view.findViewById(R.id.brick_drone_turn_right_text_view_power);
			TextView editPower = (TextView) view.findViewById(R.id.brick_drone_turn_right_edit_text_power);
