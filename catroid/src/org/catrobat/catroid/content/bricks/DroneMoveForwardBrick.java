...
public class DroneMoveForwardBrick extends BrickBaseType implements OnClickListener, FormulaBrick {
	...
	public DroneMoveForwardBrick(Sprite sprite, int timeInMillisecondsValue) {
		this.sprite = sprite;
		timeToFlyInSeconds = new Formula(timeInMillisecondsValue / 1000.0);
	}

	public DroneMoveForwardBrick(Sprite sprite, Formula time) {
		this.sprite = sprite;
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		TextView text = (TextView) view.findViewById(R.id.brick_drone_move_forward_prototype_text_view);
		TextView edit = (TextView) view.findViewById(R.id.brick_drone_move_forward_edit_text);
		timeToFlyInSeconds.setTextFieldId(R.id.brick_drone_move_forward_edit_text);
		timeToFlyInSeconds.refreshTextField(view);

		TextView times = (TextView) view.findViewById(R.id.brick_drone_move_forward_second_text_view);
	...
	public View getPrototypeView(Context context) {
		...
		TextView textWait = (TextView) prototypeView.findViewById(R.id.brick_drone_move_forward_prototype_text_view);
		textWait.setText(String.valueOf(timeToFlyInSeconds.interpretInteger(sprite)));
		TextView times = (TextView) prototypeView.findViewById(R.id.brick_drone_move_forward_second_text_view);
	...
	@Override
	public Brick clone() {
		return new DroneMoveForwardBrick(getSprite(), timeToFlyInSeconds.clone());
	}
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			TextView textWaitLabel = (TextView) view.findViewById(R.id.brick_drone_move_forward_label);
			TextView textWaitSeconds = (TextView) view.findViewById(R.id.brick_drone_move_forward_second_text_view);
			TextView editWait = (TextView) view.findViewById(R.id.brick_drone_move_forward_edit_text);
	...
	public List<SequenceAction> addActionToSequence(SequenceAction sequence) {
		sequence.addAction(ExtendedActions.droneMoveForward(sprite, timeToFlyInSeconds));
		return null;
	}
}
