...
public class DroneMoveUpBrick extends BrickBaseType implements OnClickListener, FormulaBrick {
	...
	public DroneMoveUpBrick(Sprite sprite, int timeInMillisecondsValue) {
		this.sprite = sprite;
		timeToFlyInSeconds = new Formula(timeInMillisecondsValue / 1000.0);
	}

	public DroneMoveUpBrick(Sprite sprite, Formula time) {
		this.sprite = sprite;
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		TextView text = (TextView) view.findViewById(R.id.brick_drone_move_up_prototype_text_view);
		TextView edit = (TextView) view.findViewById(R.id.brick_drone_move_up_edit_text);
		timeToFlyInSeconds.setTextFieldId(R.id.brick_drone_move_up_edit_text);
		timeToFlyInSeconds.refreshTextField(view);

		TextView times = (TextView) view.findViewById(R.id.brick_drone_move_up_second_text_view);
	...
	public View getPrototypeView(Context context) {
		...
		TextView textWait = (TextView) prototypeView.findViewById(R.id.brick_drone_move_up_prototype_text_view);
		textWait.setText(String.valueOf(timeToFlyInSeconds.interpretInteger(sprite)));
		TextView times = (TextView) prototypeView.findViewById(R.id.brick_drone_move_up_second_text_view);
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			TextView textWaitLabel = (TextView) view.findViewById(R.id.brick_drone_move_up_label);
			TextView textWaitSeconds = (TextView) view.findViewById(R.id.brick_drone_move_up_second_text_view);
			TextView editWait = (TextView) view.findViewById(R.id.brick_drone_move_up_edit_text);
