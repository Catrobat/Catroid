...
public class DroneMoveUpBrick extends BrickBaseType implements OnClickListener, FormulaBrick {
	private static final long serialVersionUID = 1L;
	private Formula timeToFlyInSeconds;
	private Formula powerInPercent;
	private transient View prototypeView;

	public DroneMoveUpBrick(Sprite sprite, int timeInMillisecondsValue, int powerInPercent) {
		this.sprite = sprite;
		this.timeToFlyInSeconds = new Formula(timeInMillisecondsValue / 1000.0);
		this.powerInPercent = new Formula(powerInPercent);
	}

	public DroneMoveUpBrick(Sprite sprite, Formula time, Formula powerInPercent) {
		this.sprite = sprite;
	...
	public Brick copyBrickForSprite(Sprite sprite, Script script) {
		DroneMoveUpBrick copyBrick = (DroneMoveUpBrick) clone();
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		TextView textTime = (TextView) view.findViewById(R.id.brick_drone_move_up_prototype_text_view_second);
		TextView editTime = (TextView) view.findViewById(R.id.brick_drone_move_up_edit_text_second);
		timeToFlyInSeconds.setTextFieldId(R.id.brick_drone_move_up_edit_text_second);
		timeToFlyInSeconds.refreshTextField(view);

		TextView times = (TextView) view.findViewById(R.id.brick_drone_move_up_text_view_second);
		...
		TextView textPower = (TextView) view.findViewById(R.id.brick_drone_move_up_prototype_text_view_power);
		TextView editPower = (TextView) view.findViewById(R.id.brick_drone_move_up_edit_text_power);
		powerInPercent.setTextFieldId(R.id.brick_drone_move_up_edit_text_power);
		powerInPercent.refreshTextField(view);

		//TextView power = (TextView) view.findViewById(R.id.brick_drone_move_up_text_view_power);
	...
	public View getPrototypeView(Context context) {
		prototypeView = View.inflate(context, R.layout.brick_drone_move_up, null);
		TextView textTime = (TextView) prototypeView.findViewById(R.id.brick_drone_move_up_prototype_text_view_second);
		textTime.setText(String.valueOf(timeToFlyInSeconds.interpretInteger(sprite)));
		TextView times = (TextView) prototypeView.findViewById(R.id.brick_drone_move_up_text_view_second);
		times.setText(context.getResources().getQuantityString(R.plurals.second_plural,
				Utils.convertDoubleToPluralInteger(timeToFlyInSeconds.interpretDouble(sprite))));

		TextView textPower = (TextView) prototypeView.findViewById(R.id.brick_drone_move_up_prototype_text_view_power);
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			View layout = view.findViewById(R.id.brick_drone_move_up_layout);
			Drawable background = layout.getBackground();
			background.setAlpha(alphaValue);

			TextView textTimeLabel = (TextView) view.findViewById(R.id.brick_drone_move_up_label);
			TextView textPercent = (TextView) view.findViewById(R.id.brick_set_size_to_percent);

			TextView textTimeSeconds = (TextView) view.findViewById(R.id.brick_drone_move_up_text_view_second);
			TextView editTime = (TextView) view.findViewById(R.id.brick_drone_move_up_edit_text_second);

			TextView textPower = (TextView) view.findViewById(R.id.brick_drone_move_up_text_view_power);
			TextView editPower = (TextView) view.findViewById(R.id.brick_drone_move_up_edit_text_power);
	...
	public void onClick(View view) {
		...
		switch (view.getId()) {
			case R.id.brick_drone_move_up_edit_text_second:
				FormulaEditorFragment.showFragment(view, this, timeToFlyInSeconds);
				break;

			case R.id.brick_drone_move_up_edit_text_power:
