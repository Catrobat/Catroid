...
public class WhenBackgroundChangesBrick extends ScriptBrick implements OnLookDataListChangedAfterNewListener {
	...
	private Sprite getSprite() {
		return ProjectManager.getInstance().getCurrentProject().getSpriteList().get(0);
	}
}
