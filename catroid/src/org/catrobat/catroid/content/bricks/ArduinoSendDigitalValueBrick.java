...
public class ArduinoSendDigitalValueBrick extends FormulaBrick {
	...
	public View getViewWithAlpha(int alphaValue) {
		if (view != null) {
			View layout = view.findViewById(R.id.brick_arduino_send_digital_layout);
			Drawable background = layout.getBackground();
			background.setAlpha(alphaValue);

			TextView textPinNumber = (TextView) view.findViewById(R.id.brick_arduino_set_digital_pin_text_view);
			TextView textgPinValue = (TextView) view.findViewById(R.id.brick_arduino_set_digital_value_text_view);
			TextView editPinNumber = (TextView) view.findViewById(R.id.brick_arduino_set_digital_pin_edit_text);
			TextView editPinValue = (TextView) view.findViewById(R.id.brick_arduino_set_digital_value_edit_text);
	...
	public List<SequenceAction> addActionToSequence(Sprite sprite, SequenceAction sequence) {
		sequence.addAction(ExtendedActions.sendDigitalArduinoValue(sprite,
