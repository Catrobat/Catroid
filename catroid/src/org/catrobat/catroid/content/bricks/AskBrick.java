...
public class AskBrick extends UserVariableBrick {
	...
	public AskBrick(Formula formula) {
		question = formula;
	...
	public int getRequiredResources() {
		return NETWORK_CONNECTION | getFormulaWithBrickField(BrickField.ASK).getRequiredResources();
	}

	public AskBrick(String question) {
		this.question = new Formula(question);
		initializeBrickFields(this.question);
	}

	private void initializeBrickFields(Formula speak) {
		addAllowedBrickField(BrickField.ASK);
		setFormulaWithBrickField(BrickField.ASK, speak);
	}
	...
	public View getView(final Context context, int brickId, BaseAdapter baseAdapter) {
		...
		TextView prototypeText = (TextView) view.findViewById(R.id.brick_ask_edit_text_preview);
		TextView textField = (TextView) view.findViewById(R.id.brick_ask_edit_text);
		textField.setText(context.getString(R.string.brick_ask_default_value));
		prototypeText.setVisibility(View.GONE);
		getFormulaWithBrickField(BrickField.ASK).setTextFieldId(R.id.brick_ask_edit_text);
		getFormulaWithBrickField(BrickField.ASK).refreshTextField(view);
		textField.setVisibility(View.VISIBLE);
		textField.setOnClickListener(this);

		Spinner variableSpinner = (Spinner) view.findViewById(R.id.brick_ask_set_variable_spinner);
	...
	public View getViewWithAlpha(int alphaValue) {
		if (view != null) {
			...
			TextView textSetVariable = (TextView) view.findViewById(R.id.brick_ask_pre_text_view);
			TextView textTo = (TextView) view.findViewById(R.id.brick_ask_pre_spinner_view);
			TextView editVariable = (TextView) view.findViewById(R.id.brick_ask_edit_text);
			Spinner variablebrickSpinner = (Spinner) view.findViewById(R.id.brick_ask_set_variable_spinner);
	...
	public View getPrototypeView(Context context) {
		...
		View prototypeView = View.inflate(context, R.layout.brick_speech_to_text, null);
		Spinner variableSpinner = (Spinner) prototypeView.findViewById(R.id.brick_ask_set_variable_spinner);
		UserBrick currentBrick = ProjectManager.getInstance().getCurrentUserBrick();
		...
		TextView textSetVariable = (TextView) prototypeView.findViewById(R.id.brick_ask_edit_text_preview);

		textSetVariable.setText(context.getString(R.string.brick_ask_default_value));
	...
	@Override
	public Brick clone() {
		return new AskBrick(this.question);
	}

	@Override
	public void showFormulaEditorToEditFormula(View view) {
		FormulaEditorFragment.showFragment(view, this, BrickField.ASK);
	}

	@Override
	public List<SequenceAction> addActionToSequence(Sprite sprite, SequenceAction sequence) {
		sequence.addAction(sprite.getActionFactory().createAskAction(sprite, this.question, userVariable));
		return null;
	}
