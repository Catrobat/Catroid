...
public final class ServerCalls {
    ...
    private static final String SIGNIN_GOOGLE_CODE_KEY = "client_token";
    private static final String SIGNIN_STATE = ""; //not supported yet, but necessary for server call
    ...
    private static final String CHECK_IS_OAUTH_USER_URL = Constants.BASE_URL_HTTPS +
            "api/IsOAuthUser/IsOAuthUser.json";
    ...
    private static final String TEST_CHECK_USERNAME_AVAILABLE_URL = BASE_URL_TEST_HTTPS +
            "api/UsernameAvailable/UsernameAvailable.json";
    private static final String TEST_CHECK_IS_OAUTH_USER_URL = BASE_URL_TEST_HTTPS +
            "api/IsOAuthUser/IsOAuthUser.json";
    ...
    public Boolean checkOAuthToken(String id, String oauthProvider) throws WebconnectionException {
        try {
            HashMap<String, String> postValues = new HashMap<>();
    ...
    public Boolean checkEMailAvailable(String email) throws WebconnectionException {
        try {
            ...
            boolean emailAvailable = jsonObject.getBoolean(EMAIL_AVAILABLE);
            //if (statusCode != SERVER_RESPONSE_TOKEN_OK) {
            //    throw new WebconnectionException(statusCode, serverAnswer);
            //}
    ...
    public Boolean checkUserNameAvailable(String username) throws WebconnectionException {
        try {
            ...
            boolean usernameAvailable = jsonObject.getBoolean(USERNAME_AVAILABLE);
            //if (statusCode != SERVER_RESPONSE_TOKEN_OK) {
            //    throw new WebconnectionException(statusCode, serverAnswer);
            //}
    ...
    public boolean googleLogin(String mail, String username, String id, String locale) throws
            WebconnectionException {
