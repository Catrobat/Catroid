...
public class CollisionReceiverBrick extends ScriptBrick implements BroadcastMessage, Cloneable {
	...
	public CollisionReceiverBrick(Sprite sprite, String spriteName) {
		this.sprite = sprite;
		this.collisionSpriteName = spriteName;
	}

	public CollisionReceiverBrick(Sprite sprite, CollisionScript receiveScript) {
		this.sprite = sprite;
	...
	public Brick copyBrickForSprite(Sprite sprite, Script script) {
		...
		copyBrick.receiveScript = (CollisionScript) script;
		return copyBrick;
	}

	@Override
	public Brick clone() {
		return new CollisionReceiverBrick(sprite, new CollisionScript(sprite, getBroadcastMessage()));
	}
	...
	public View getView(final Context context, int brickId, BaseAdapter baseAdapter) {
		...
		if (receiveScript == null) {
			receiveScript = new CollisionScript(sprite, collisionSpriteName);
