...
public class TurnRightSpeedBrick extends BrickBaseType implements OnClickListener, Cloneable {
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		degreesPerSecond.setTextFieldId(R.id.brick_turn_right_speed_edit_text);
	...
	public List<SequenceAction> addActionToSequence(SequenceAction sequence) {
		...
		sequence.addAction(sprite.getActionFactory().createTurnRightSpeedAction(sprite, degreesPerSecond));
		return null;
	}
}
