...
public class FacebookExchangeTokenTask extends AsyncTask<Void, Void, Boolean> {
    ...
    public FacebookExchangeTokenTask(FragmentActivity activity, String clientToken, String mail, String username, String id, String locale) {
    ...
    protected void onPostExecute(Boolean result) {
        ...
        if (onFacebookExchangeTokenCompleteListener != null) {
            onFacebookExchangeTokenCompleteListener.onFacebookExchangeTokenComplete();
        }
    }
    ...
    public interface OnFacebookExchangeTokenCompleteListener {
        void onFacebookExchangeTokenComplete();
    }
