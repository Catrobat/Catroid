...
public class CheckVersionTask extends AsyncTask<Void, Void, Boolean> {
	...
	public CheckVersionTask(Activity activity, String version, String projectName) {
	...
	protected void onPostExecute(Boolean success) {
		...
		if (isVersionSameAsPlayStore) {
			if (onCheckVersionListener != null) {
				onCheckVersionListener.onVersionValid(activity, projectName);
			}
			return;
		} else {
			if (onCheckVersionListener != null) {
				onCheckVersionListener.onVersionInvalid(activity, projectName);
			}
			return;
		}
	}
	...
	public interface OnCheckVersionListener {
		...
		void onVersionValid(Activity activity, String projectName);

		void onVersionInvalid(Activity activit, String projectNamey);
	}
}
