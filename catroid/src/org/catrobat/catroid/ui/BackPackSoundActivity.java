...
public class BackPackSoundActivity extends SherlockFragmentActivity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
			...
			case R.id.settings:
				Intent settingsIntent = new Intent(BackPackSoundActivity.this, SettingsActivity.class);
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == PreStageActivity.REQUEST_RESOURCES_INIT && resultCode == RESULT_OK) {
			...
			Intent intent = new Intent(BackPackSoundActivity.this, StageActivity.class);
	...
	public void switchToFragmentFromScriptFragment(int fragmentPosition) {
		...
		ScriptActivityFragment scriptFragment = getFragment(BackPackSoundActivity.FRAGMENT_SCRIPTS);
		FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
