...
public final class SoundController {
	...
	public void deleteSoundFromList(SoundInfo soundInfo, ArrayList<SoundInfo> soundInfoList, SoundBaseAdapter adapter,
			Stack<SoundInfo> undoSoundInfoStack) {
		undoSoundInfoStack.push(soundInfo);
		soundInfoList.remove(soundInfo);
		ProjectManager.getInstance().getCurrentSprite().setSoundList(soundInfoList);
		adapter.notifyDataSetChanged();
	}

	public void addSoundToList(SoundInfo soundInfo, ArrayList<SoundInfo> soundInfoList, SoundBaseAdapter adapter,
			Stack<SoundInfo> redoSoundInfoStack) {
		redoSoundInfoStack.push(soundInfo);
		soundInfoList.add(soundInfo);
		ProjectManager.getInstance().getCurrentSprite().setSoundList(soundInfoList);
		adapter.notifyDataSetChanged();
	}

	public void deleteSound(SoundInfo soundInfo, Activity activity) {
	...
	public void deleteCheckedSounds(Activity activity, SoundBaseAdapter adapter, ArrayList<SoundInfo> soundInfoList,
			Stack<SoundInfo> undoSoundInfoStack, MediaPlayer mediaPlayer) {
		...
		while (iterator.hasNext()) {
			...
			//			deleteSound(position - numberDeleted, soundInfoList, undoSoundInfoStack, activity);
			deleteSoundFromList(soundInfoList.get(position - numberDeleted), soundInfoList, adapter, undoSoundInfoStack);
			++numberDeleted;
		}
	}
