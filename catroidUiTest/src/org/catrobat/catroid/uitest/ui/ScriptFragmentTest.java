...
public class ScriptFragmentTest extends ActivityInstrumentationTestCase2<MainMenuActivity> {
	...
	public void testBrickCategoryDialog() {
		...
		assertTrue("AddBrickDialog was not opened after selecting a category",
				solo.waitForText(brickPlaceAtText, 0, 500));
		solo.goBack();

		solo.clickOnText(solo.getString(R.string.category_looks));
		assertTrue("AddBrickDialog was not opened after selecting a category",
				solo.waitForText(brickSetCostume, 0, 500));
		solo.goBack();

		solo.clickOnText(solo.getString(R.string.category_sound));
		assertTrue("AddBrickDialog was not opened after selecting a category", solo.waitForText(brickPlaySound, 0, 500));
		solo.goBack();

		solo.clickOnText(solo.getString(R.string.category_control));
		assertTrue("AddBrickDialog was not opened after selecting a category",
				solo.waitForText(brickWhenStarted, 0, 500));
	}
