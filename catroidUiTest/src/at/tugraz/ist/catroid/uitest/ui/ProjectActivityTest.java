...
public class ProjectActivityTest extends ActivityInstrumentationTestCase2<MainMenuActivity> {
	...
	public void testSpriteListDetails() {
		...
		int costumeCountActual = Integer.parseInt(scriptCountString.substring(costumeCountString.lastIndexOf(' ') + 1));
		...
		int soundCountActual = Integer.parseInt(scriptCountString.substring(soundCountString.lastIndexOf(' ') + 1));
